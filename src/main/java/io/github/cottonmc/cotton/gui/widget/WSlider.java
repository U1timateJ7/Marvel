...
public class WSlider extends WAbstractSlider {
    ...
    public static final ResourceLocation LIGHT_TEXTURE = ResourceLocation.fromNamespaceAndPath(LibGui.MOD_ID, "textures/widget/slider_light.png");
    public static final ResourceLocation DARK_TEXTURE = ResourceLocation.fromNamespaceAndPath(LibGui.MOD_ID, "textures/widget/slider_dark.png");
