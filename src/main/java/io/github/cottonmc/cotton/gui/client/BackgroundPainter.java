...
public interface BackgroundPainter {
    ...
    public static BackgroundPainter VANILLA = createLightDarkVariants(
            createGuiSprite(ResourceLocation.fromNamespaceAndPath(LibGui.MOD_ID, "widget/panel_light")),
            createGuiSprite(ResourceLocation.fromNamespaceAndPath(LibGui.MOD_ID, "widget/panel_dark"))
    );
     ...
     * as a simpler and more data-driven alternative to {@link #createNinePatch(ResourceLocation)}.
     *
