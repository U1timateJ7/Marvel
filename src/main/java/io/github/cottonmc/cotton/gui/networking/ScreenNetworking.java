 ...
 * Messages can be sent by calling {@link #send(ResourceLocation, RegistryAccess, Consumer)} on a {@code ScreenNetworking}
...
public interface ScreenNetworking {
     ...
     * @throws NullPointerException if either parameter is null
     */
    void send(ResourceLocation message, RegistryAccess registryAccess, Consumer<RegistryFriendlyByteBuf> writer);
