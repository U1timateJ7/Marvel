...
public class ScreenNetworkingImpl implements ScreenNetworking {
    ...
    public static final ResourceLocation SCREEN_MESSAGE_S2C = ResourceLocation.fromNamespaceAndPath(LibGui.MOD_ID, "screen_message_s2c");
    public static final ResourceLocation SCREEN_MESSAGE_C2S = ResourceLocation.fromNamespaceAndPath(LibGui.MOD_ID, "screen_message_c2s");
    ...
    @Override
    public void send(ResourceLocation message, RegistryAccess registryAccess, Consumer<RegistryFriendlyByteBuf> writer) {
        Objects.requireNonNull(message, "message");
        Objects.requireNonNull(writer, "writer");

        RegistryFriendlyByteBuf buf = PacketByteBufs.create(registryAccess);
    ...
    public static void handle(Executor executor, Player player, RegistryFriendlyByteBuf buf) {
