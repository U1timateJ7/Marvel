...
public class MarvelDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> CLAWS_OUT = register("claws_out", () -> DataComponentType.<Unit>builder().persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).build());
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> SPEEDING = register("speeding", () -> DataComponentType.<Unit>builder().persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).build());
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> WINTER_SOLDIER = register("winter_soldier", () -> DataComponentType.<Unit>builder().persistent(Unit.CODEC).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
