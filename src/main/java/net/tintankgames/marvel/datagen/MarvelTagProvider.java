...
public class MarvelTagProvider {
    ...
    public static class BlockProvider extends BlockTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelBlocks.NeoTags.ORES_VIBRANIUM).addTag(MarvelBlocks.Tags.VIBRANIUM_ORES);
            tag(MarvelBlocks.NeoTags.ORES_TITANIUM).addTag(MarvelBlocks.Tags.TITANIUM_ORES);
            tag(MarvelBlocks.NeoTags.ORES_PALLADIUM).addTag(MarvelBlocks.Tags.PALLADIUM_ORES);
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_VIBRANIUM).add(MarvelBlocks.VIBRANIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_TITANIUM).add(MarvelBlocks.TITANIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_RAW_TITANIUM).add(MarvelBlocks.RAW_TITANIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_PALLADIUM).add(MarvelBlocks.PALLADIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_RAW_PALLADIUM).add(MarvelBlocks.RAW_PALLADIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_GOLD_TITANIUM).add(MarvelBlocks.GOLD_TITANIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_ADAMANTIUM).add(MarvelBlocks.ADAMANTIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_PROTO_ADAMANTIUM).add(MarvelBlocks.PROTO_ADAMANTIUM_BLOCK.get());
            tag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_URU).add(MarvelBlocks.URU_BLOCK.get());

            tag(Tags.Blocks.ORES).addTag(MarvelBlocks.NeoTags.ORES_VIBRANIUM).addTag(MarvelBlocks.NeoTags.ORES_TITANIUM).addTag(MarvelBlocks.NeoTags.ORES_PALLADIUM);
            tag(Tags.Blocks.STORAGE_BLOCKS).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_VIBRANIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_TITANIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_RAW_TITANIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_PALLADIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_RAW_PALLADIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_GOLD_TITANIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_ADAMANTIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_PROTO_ADAMANTIUM).addTag(MarvelBlocks.NeoTags.STORAGE_BLOCKS_URU);
            tag(Tags.Blocks.ORE_RATES_SINGULAR).add(MarvelBlocks.VIBRANIUM_ORE.get(), MarvelBlocks.TITANIUM_ORE.get(), MarvelBlocks.PALLADIUM_ORE.get(), MarvelBlocks.DEEPSLATE_VIBRANIUM_ORE.get(), MarvelBlocks.DEEPSLATE_TITANIUM_ORE.get(), MarvelBlocks.DEEPSLATE_PALLADIUM_ORE.get());
            tag(Tags.Blocks.ORES_IN_GROUND_STONE).add(MarvelBlocks.VIBRANIUM_ORE.get(), MarvelBlocks.TITANIUM_ORE.get(), MarvelBlocks.PALLADIUM_ORE.get());
            tag(Tags.Blocks.ORES_IN_GROUND_DEEPSLATE).add(MarvelBlocks.DEEPSLATE_VIBRANIUM_ORE.get(), MarvelBlocks.DEEPSLATE_TITANIUM_ORE.get(), MarvelBlocks.DEEPSLATE_PALLADIUM_ORE.get());
        }
    }
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelItems.Tags.IRON_MAN_MARK_23_HELMET).add(MarvelItems.IRON_MAN_MARK_23_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_23_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_23_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_23_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_23_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_23_BOOTS).add(MarvelItems.IRON_MAN_MARK_23_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_24_HELMET).add(MarvelItems.IRON_MAN_MARK_24_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_24_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_24_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_24_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_24_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_24_BOOTS).add(MarvelItems.IRON_MAN_MARK_24_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_25_HELMET).add(MarvelItems.IRON_MAN_MARK_25_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_25_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_25_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_25_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_25_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_25_BOOTS).add(MarvelItems.IRON_MAN_MARK_25_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_28_HELMET).add(MarvelItems.IRON_MAN_MARK_28_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_28_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_28_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_28_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_28_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_28_BOOTS).add(MarvelItems.IRON_MAN_MARK_28_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_30_HELMET).add(MarvelItems.IRON_MAN_MARK_30_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_30_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_30_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_30_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_30_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_30_BOOTS).add(MarvelItems.IRON_MAN_MARK_30_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_33_HELMET).add(MarvelItems.IRON_MAN_MARK_33_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_33_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_33_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_33_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_33_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_33_BOOTS).add(MarvelItems.IRON_MAN_MARK_33_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_35_HELMET).add(MarvelItems.IRON_MAN_MARK_35_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_35_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_35_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_35_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_35_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_35_BOOTS).add(MarvelItems.IRON_MAN_MARK_35_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_37_HELMET).add(MarvelItems.IRON_MAN_MARK_37_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_37_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_37_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_37_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_37_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_37_BOOTS).add(MarvelItems.IRON_MAN_MARK_37_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_38_HELMET).add(MarvelItems.IRON_MAN_MARK_38_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_38_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_38_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_38_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_38_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_38_BOOTS).add(MarvelItems.IRON_MAN_MARK_38_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_39_HELMET).add(MarvelItems.IRON_MAN_MARK_39_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_39_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_39_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_39_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_39_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_39_BOOTS).add(MarvelItems.IRON_MAN_MARK_39_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_42_HELMET).add(MarvelItems.IRON_MAN_MARK_42_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_42_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_42_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_42_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_42_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_42_BOOTS).add(MarvelItems.IRON_MAN_MARK_42_BOOTS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_43_HELMET).add(MarvelItems.IRON_MAN_MARK_43_HELMET.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_43_CHESTPLATE).add(MarvelItems.IRON_MAN_MARK_43_CHESTPLATE.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_43_LEGGINGS).add(MarvelItems.IRON_MAN_MARK_43_LEGGINGS.get());
            tag(MarvelItems.Tags.IRON_MAN_MARK_43_BOOTS).add(MarvelItems.IRON_MAN_MARK_43_BOOTS.get());
            ...
            tag(MarvelItems.Tags.IRON_MAN_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_20_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_21_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_22_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_HELMET).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_HELMET).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_2_HELMET);
            tag(MarvelItems.Tags.IRON_MAN_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_20_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_21_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_22_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_CHESTPLATE).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_CHESTPLATE).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_2_CHESTPLATE);
            tag(MarvelItems.Tags.IRON_MAN_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_20_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_21_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_22_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_LEGGINGS).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_LEGGINGS).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_2_LEGGINGS);
            tag(MarvelItems.Tags.IRON_MAN_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_20_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_21_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_22_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_BOOTS).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_BOOTS).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_2_BOOTS);
            ...
            tag(MarvelItems.Tags.IRON_MAN_MARK_23_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_23_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_24_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_24_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_25_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_25_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_28_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_28_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_30_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_30_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_33_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_33_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_35_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_35_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_37_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_37_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_38_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_38_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_39_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_39_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_42_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_42_BOOTS);
            tag(MarvelItems.Tags.IRON_MAN_MARK_43_ARMOR).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_43_BOOTS);
            ...
            tag(MarvelItems.NeoTags.INGOTS_VIBRANIUM).add(MarvelItems.VIBRANIUM_INGOT.get());
            tag(MarvelItems.NeoTags.INGOTS_TITANIUM).add(MarvelItems.TITANIUM_INGOT.get());
            tag(MarvelItems.NeoTags.INGOTS_PALLADIUM).add(MarvelItems.PALLADIUM_INGOT.get());
            tag(MarvelItems.NeoTags.INGOTS_GOLD_TITANIUM).add(MarvelItems.GOLD_TITANIUM_INGOT.get());
            tag(MarvelItems.NeoTags.INGOTS_ADAMANTIUM).add(MarvelItems.ADAMANTIUM_INGOT.get());
            tag(MarvelItems.NeoTags.INGOTS_PROTO_ADAMANTIUM).add(MarvelItems.PROTO_ADAMANTIUM_INGOT.get());
            tag(MarvelItems.NeoTags.INGOTS_URU).add(MarvelItems.URU_INGOT.get());
            tag(MarvelItems.NeoTags.NUGGETS_VIBRANIUM).add(MarvelItems.VIBRANIUM_NUGGET.get());
            tag(MarvelItems.NeoTags.NUGGETS_TITANIUM).add(MarvelItems.TITANIUM_NUGGET.get());
            tag(MarvelItems.NeoTags.NUGGETS_PALLADIUM).add(MarvelItems.PALLADIUM_NUGGET.get());
            tag(MarvelItems.NeoTags.NUGGETS_GOLD_TITANIUM).add(MarvelItems.GOLD_TITANIUM_NUGGET.get());
            tag(MarvelItems.NeoTags.NUGGETS_ADAMANTIUM).add(MarvelItems.ADAMANTIUM_NUGGET.get());
            tag(MarvelItems.NeoTags.NUGGETS_PROTO_ADAMANTIUM).add(MarvelItems.PROTO_ADAMANTIUM_NUGGET.get());
            tag(MarvelItems.NeoTags.NUGGETS_URU).add(MarvelItems.URU_NUGGET.get());
            tag(MarvelItems.NeoTags.RAW_MATERIALS_VIBRANIUM).add(MarvelItems.VIBRANIUM.get());
            tag(MarvelItems.NeoTags.RAW_MATERIALS_TITANIUM).add(MarvelItems.RAW_TITANIUM.get());
            tag(MarvelItems.NeoTags.RAW_MATERIALS_PALLADIUM).add(MarvelItems.RAW_PALLADIUM.get());
            copy(MarvelBlocks.NeoTags.ORES_VIBRANIUM, MarvelItems.NeoTags.ORES_VIBRANIUM);
            copy(MarvelBlocks.NeoTags.ORES_TITANIUM, MarvelItems.NeoTags.ORES_TITANIUM);
            copy(MarvelBlocks.NeoTags.ORES_PALLADIUM, MarvelItems.NeoTags.ORES_PALLADIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_VIBRANIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_VIBRANIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_TITANIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_TITANIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_RAW_TITANIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_RAW_TITANIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_PALLADIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_PALLADIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_RAW_PALLADIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_RAW_PALLADIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_GOLD_TITANIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_GOLD_TITANIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_ADAMANTIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_ADAMANTIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_PROTO_ADAMANTIUM, MarvelItems.NeoTags.STORAGE_BLOCKS_PROTO_ADAMANTIUM);
            copy(MarvelBlocks.NeoTags.STORAGE_BLOCKS_URU, MarvelItems.NeoTags.STORAGE_BLOCKS_URU);

            tag(Tags.Items.INGOTS).addTag(MarvelItems.NeoTags.INGOTS_VIBRANIUM).addTag(MarvelItems.NeoTags.INGOTS_TITANIUM).addTag(MarvelItems.NeoTags.INGOTS_PALLADIUM).addTag(MarvelItems.NeoTags.INGOTS_GOLD_TITANIUM).addTag(MarvelItems.NeoTags.INGOTS_ADAMANTIUM).addTag(MarvelItems.NeoTags.INGOTS_PROTO_ADAMANTIUM).addTag(MarvelItems.NeoTags.INGOTS_URU);
            tag(Tags.Items.NUGGETS).addTag(MarvelItems.NeoTags.NUGGETS_VIBRANIUM).addTag(MarvelItems.NeoTags.NUGGETS_TITANIUM).addTag(MarvelItems.NeoTags.NUGGETS_PALLADIUM).addTag(MarvelItems.NeoTags.NUGGETS_GOLD_TITANIUM).addTag(MarvelItems.NeoTags.NUGGETS_ADAMANTIUM).addTag(MarvelItems.NeoTags.NUGGETS_PROTO_ADAMANTIUM).addTag(MarvelItems.NeoTags.NUGGETS_URU);
            tag(Tags.Items.RAW_MATERIALS).addTag(MarvelItems.NeoTags.RAW_MATERIALS_VIBRANIUM).addTag(MarvelItems.NeoTags.RAW_MATERIALS_TITANIUM).addTag(MarvelItems.NeoTags.RAW_MATERIALS_PALLADIUM);
            ...
            tag(MarvelItems.CurioTags.NECKLACE).add(MarvelItems.KINETIC_BLACK_PANTHER_NECKLACE.get(), MarvelItems.KILLMONGER_NECKLACE.get(), MarvelItems.BLACK_PANTHER_SHURI_NECKLACE.get());
        }
    }
