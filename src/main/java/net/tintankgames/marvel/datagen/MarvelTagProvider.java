...
public class MarvelTagProvider {
    ...
    public static class BlockProvider extends BlockTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(BlockTags.SLABS).add(MarvelBlocks.GREEN_HYDRA_BRICK_SLAB.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_SLAB.get(), MarvelBlocks.GRAY_HYDRA_BRICK_SLAB.get());
            tag(BlockTags.STAIRS).add(MarvelBlocks.GREEN_HYDRA_BRICK_STAIRS.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_STAIRS.get(), MarvelBlocks.GRAY_HYDRA_BRICK_STAIRS.get());
            tag(BlockTags.WALLS).add(MarvelBlocks.GREEN_HYDRA_BRICK_WALL.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_WALL.get(), MarvelBlocks.GRAY_HYDRA_BRICK_WALL.get());
            ...
            tag(MarvelBlocks.Tags.HYDRA_AGENT_SPAWNABLE_ON).add(MarvelBlocks.GREEN_HYDRA_BRICKS.get(), MarvelBlocks.YELLOW_HYDRA_BRICKS.get(), MarvelBlocks.GRAY_HYDRA_BRICKS.get());
        }
    }
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(ItemTags.SWORDS).add(MarvelItems.VIBRANIUM_SWORD.get(), MarvelItems.KATANAS.get());
            ...
            tag(MarvelItems.Tags.RENDER_HAND).add(MarvelItems.ADAMANTIUM_CLAWS.get(), MarvelItems.OPTIC_BLAST.get(), MarvelItems.WEB_SHOOTER.get(), MarvelItems.SHRINK.get(), MarvelItems.GROW.get(), MarvelItems.STING.get(), MarvelItems.FLAMETHROWER.get(), MarvelItems.REPULSOR.get(), MarvelItems.UNIBEAM.get(), MarvelItems.SHOULDER_TURRET.get(), MarvelItems.SONIC_BOOM.get());
