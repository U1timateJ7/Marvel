...
public class MarvelTagProvider {
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelItems.Tags.CAPTAIN_MARVEL_HELMET).add(MarvelItems.CAPTAIN_MARVEL_HELMET.get());
            tag(MarvelItems.Tags.CAPTAIN_MARVEL_CHESTPLATE).add(MarvelItems.CAPTAIN_MARVEL_CHESTPLATE.get());
            tag(MarvelItems.Tags.CAPTAIN_MARVEL_LEGGINGS).add(MarvelItems.CAPTAIN_MARVEL_LEGGINGS.get());
            tag(MarvelItems.Tags.CAPTAIN_MARVEL_BOOTS).add(MarvelItems.CAPTAIN_MARVEL_BOOTS.get());
