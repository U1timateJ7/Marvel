...
public class MarvelTagProvider {
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelItems.Tags.IRON_MAN_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_HELMET).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_HELMET).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_HELMET);
            tag(MarvelItems.Tags.IRON_MAN_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_CHESTPLATE).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_CHESTPLATE).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_CHESTPLATE);
            tag(MarvelItems.Tags.IRON_MAN_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_LEGGINGS).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_LEGGINGS).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_LEGGINGS);
            tag(MarvelItems.Tags.IRON_MAN_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_2_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_3_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_5_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_6_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_7_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_11_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_15_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_17_BOOTS).addTag(MarvelItems.Tags.IRON_MAN_MARK_19_BOOTS).addTag(MarvelItems.Tags.WAR_MACHINE_MARK_1_BOOTS);
