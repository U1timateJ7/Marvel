...
public class MarvelTagProvider {
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelItems.Tags.SPIDER_MAN_HELMET).add(MarvelItems.SPIDER_MAN_HELMET.get(), MarvelItems.SPIDER_MAN_MCU_HELMET.get(), MarvelItems.MILES_MORALES_HELMET.get(), MarvelItems.SPIDER_GWEN_HELMET.get());
            tag(MarvelItems.Tags.SPIDER_MAN_CHESTPLATE).add(MarvelItems.SPIDER_MAN_CHESTPLATE.get(), MarvelItems.SPIDER_MAN_MCU_CHESTPLATE.get(), MarvelItems.MILES_MORALES_CHESTPLATE.get(), MarvelItems.SPIDER_GWEN_CHESTPLATE.get());
            tag(MarvelItems.Tags.SPIDER_MAN_LEGGINGS).add(MarvelItems.SPIDER_MAN_LEGGINGS.get(), MarvelItems.SPIDER_MAN_MCU_LEGGINGS.get(), MarvelItems.MILES_MORALES_LEGGINGS.get(), MarvelItems.SPIDER_GWEN_LEGGINGS.get());
            tag(MarvelItems.Tags.SPIDER_MAN_BOOTS).add(MarvelItems.SPIDER_MAN_BOOTS.get(), MarvelItems.SPIDER_MAN_MCU_BOOTS.get(), MarvelItems.MILES_MORALES_BOOTS.get(), MarvelItems.SPIDER_GWEN_BOOTS.get());
    ...
    public static class DamageTypeProvider extends TagsProvider<DamageType> {
        ...
        @Override
        protected void addTags(HolderLookup.Provider arg) {
            tag(DamageTypeTags.ALWAYS_HURTS_ENDER_DRAGONS).add(MarvelDamageTypes.KINETIC_BLAST, MarvelDamageTypes.VIBRANIUM_SHIELD, MarvelDamageTypes.VIBRANIUM_SHIELD_DISPENSER, MarvelDamageTypes.OPTIC_BLAST, MarvelDamageTypes.OPTIC_BLAST_GOOFY, MarvelDamageTypes.GIANT_MAN);
            ...
            tag(DamageTypeTags.IS_PROJECTILE).add(MarvelDamageTypes.VIBRANIUM_SHIELD, MarvelDamageTypes.VIBRANIUM_SHIELD_DISPENSER, MarvelDamageTypes.WEB_SHOT);
            ...
            tag(DamageTypeTags.NO_KNOCKBACK).add(MarvelDamageTypes.OPTIC_BLAST, MarvelDamageTypes.OPTIC_BLAST_GOOFY, MarvelDamageTypes.WEB_SHOT);
            ...
            tag(DamageTypeTags.BYPASSES_SHIELD).add(MarvelDamageTypes.OPTIC_BLAST_GOOFY, MarvelDamageTypes.GIANT_MAN);
