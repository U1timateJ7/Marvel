...
public class MarvelTagProvider {
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelItems.Tags.RENDER_HAND).add(MarvelItems.ADAMANTIUM_CLAWS.get(), MarvelItems.OPTIC_BLAST.get(), MarvelItems.WEB_SHOOTER.get(), MarvelItems.SHRINK.get(), MarvelItems.GROW.get(), MarvelItems.STING.get(), MarvelItems.FLAMETHROWER.get(), MarvelItems.REPULSOR.get(), MarvelItems.UNIBEAM.get(), MarvelItems.MINING_DRILL.get(), MarvelItems.SHOULDER_TURRET.get(), MarvelItems.SONIC_BOOM.get(), MarvelItems.PHOTON_BLAST.get());
            tag(MarvelItems.Tags.POSE_HAND).add(MarvelItems.MINING_DRILL.get());
