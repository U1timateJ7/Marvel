...
public class MarvelTagProvider {
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelItems.Tags.SPIDER_MAN_HELMET).add(MarvelItems.SPIDER_MAN_HELMET.get(), MarvelItems.SPIDER_MAN_MCU_HELMET.get());
            tag(MarvelItems.Tags.SPIDER_MAN_CHESTPLATE).add(MarvelItems.SPIDER_MAN_CHESTPLATE.get(), MarvelItems.SPIDER_MAN_MCU_CHESTPLATE.get());
            tag(MarvelItems.Tags.SPIDER_MAN_LEGGINGS).add(MarvelItems.SPIDER_MAN_LEGGINGS.get(), MarvelItems.SPIDER_MAN_MCU_LEGGINGS.get());
            tag(MarvelItems.Tags.SPIDER_MAN_BOOTS).add(MarvelItems.SPIDER_MAN_BOOTS.get(), MarvelItems.SPIDER_MAN_MCU_BOOTS.get());
    ...
    public static class DamageTypeProvider extends TagsProvider<DamageType> {
        ...
        protected void addTags(HolderLookup.Provider arg) {
            ...
            tag(DamageTypeTags.IS_PLAYER_ATTACK).add(MarvelDamageTypes.KINETIC_BLAST, MarvelDamageTypes.OPTIC_BLAST, MarvelDamageTypes.OPTIC_BLAST_GOOFY, MarvelDamageTypes.GIANT_MAN);
