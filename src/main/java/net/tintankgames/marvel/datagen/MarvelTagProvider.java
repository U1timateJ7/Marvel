...
public class MarvelTagProvider {
    ...
    public static class BlockProvider extends BlockTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            tag(BlockTags.MINEABLE_WITH_PICKAXE).add(MarvelBlocks.VIBRANIUM_ORE.get(), MarvelBlocks.DEEPSLATE_VIBRANIUM_ORE.get(), MarvelBlocks.VIBRANIUM_BLOCK.get(), MarvelBlocks.TITANIUM_ORE.get(), MarvelBlocks.DEEPSLATE_TITANIUM_ORE.get(), MarvelBlocks.TITANIUM_BLOCK.get(), MarvelBlocks.RAW_TITANIUM_BLOCK.get(), MarvelBlocks.PALLADIUM_ORE.get(), MarvelBlocks.DEEPSLATE_PALLADIUM_ORE.get(), MarvelBlocks.PALLADIUM_BLOCK.get(), MarvelBlocks.RAW_PALLADIUM_BLOCK.get(), MarvelBlocks.GOLD_TITANIUM_BLOCK.get(), MarvelBlocks.ADAMANTIUM_BLOCK.get(), MarvelBlocks.PROTO_ADAMANTIUM_BLOCK.get(), MarvelBlocks.URU_BLOCK.get(), MarvelBlocks.SUIT_TABLE.get(), MarvelBlocks.SUIT_CHARGER.get(), MarvelBlocks.SUIT_CHARGER_UPPER.get(), MarvelBlocks.GREEN_HYDRA_BRICKS.get(), MarvelBlocks.GREEN_HYDRA_BRICK_SLAB.get(), MarvelBlocks.GREEN_HYDRA_BRICK_STAIRS.get(), MarvelBlocks.GREEN_HYDRA_BRICK_WALL.get(), MarvelBlocks.YELLOW_HYDRA_BRICKS.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_SLAB.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_STAIRS.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_WALL.get());
            ...
            tag(BlockTags.SLABS).add(MarvelBlocks.GREEN_HYDRA_BRICK_SLAB.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_SLAB.get());
            tag(BlockTags.STAIRS).add(MarvelBlocks.GREEN_HYDRA_BRICK_STAIRS.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_STAIRS.get());
            tag(BlockTags.WALLS).add(MarvelBlocks.GREEN_HYDRA_BRICK_WALL.get(), MarvelBlocks.YELLOW_HYDRA_BRICK_WALL.get());
    ...
    public static class ItemProvider extends ItemTagsProvider {
        ...
        protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(MarvelItems.Tags.QUICKSILVER_CHESTPLATE).add(MarvelItems.QUICKSILVER_CHESTPLATE.get());
            tag(MarvelItems.Tags.QUICKSILVER_LEGGINGS).add(MarvelItems.QUICKSILVER_LEGGINGS.get());
            tag(MarvelItems.Tags.QUICKSILVER_BOOTS).add(MarvelItems.QUICKSILVER_BOOTS.get());
    ...
    public static class DamageTypeProvider extends TagsProvider<DamageType> {
        ...
        protected void addTags(HolderLookup.Provider arg) {
            ...
            tag(DamageTypeTags.IS_PLAYER_ATTACK).add(MarvelDamageTypes.KINETIC_BLAST, MarvelDamageTypes.OPTIC_BLAST, MarvelDamageTypes.OPTIC_BLAST_GOOFY, MarvelDamageTypes.WEB_SHOT, MarvelDamageTypes.GIANT_MAN, MarvelDamageTypes.QUICKSILVER_ATTACK);
