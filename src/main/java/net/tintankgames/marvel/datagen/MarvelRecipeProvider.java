...
public class MarvelRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MarvelItems.URU_INGOT).define('#', Tags.Items.INGOTS_GOLD).define('X', Items.NETHER_STAR).pattern("###").pattern("#X#").pattern("###").unlockedBy("has_gold_ingot", has(Tags.Items.INGOTS_GOLD)).save(output);
