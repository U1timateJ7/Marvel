...
public class MarvelRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, MarvelItems.CYCLOPS_HELMET).define('#', Tags.Items.DYES_BLUE).define('G', Tags.Items.INGOTS_GOLD).define('X', MarvelItems.REINFORCED_LEATHER).define('R', Blocks.RED_STAINED_GLASS_PANE).pattern("X#X").pattern("GRG").unlockedBy("has_reinforced_leather", has(MarvelItems.REINFORCED_LEATHER)).save(output);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, MarvelItems.ANT_MAN_CHESTPLATE).define('#', Tags.Items.DYES_RED).define('B', Tags.Items.DYES_BLACK).define('S', Blocks.STONE_BUTTON).define('X', MarvelItems.REINFORCED_LEATHER).pattern("X X").pattern("##S").pattern("XBX").unlockedBy("has_reinforced_leather", has(MarvelItems.REINFORCED_LEATHER)).save(output);
