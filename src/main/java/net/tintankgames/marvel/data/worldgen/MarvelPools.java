...
public class MarvelPools {
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> bootstrapContext) {
        ...
        bootstrapContext.register(HYDRA_BASE_CLASSIC_PRISONER_TERMINATORS, new StructureTemplatePool(classicPrisonerTerminators, List.of(Pair.of(UndergroundPoolElement.create(MarvelSuperheroes.id("hydra_base/classic/prisoner/prisoner_01").toString()).apply(StructureTemplatePool.Projection.RIGID), 1))));
    }
}
