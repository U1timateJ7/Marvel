...
public class MarvelBlocks {
    ...
    public static final DeferredBlock<Block> TITANIUM_ORE = register("titanium_ore", () -> new DropExperienceBlock(ConstantInt.of(0), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 1200.0F)));
    public static final DeferredBlock<Block> DEEPSLATE_TITANIUM_ORE = register("deepslate_titanium_ore", () -> new DropExperienceBlock(ConstantInt.of(0), BlockBehaviour.Properties.ofLegacyCopy(MarvelBlocks.TITANIUM_ORE.get()).mapColor(MapColor.DEEPSLATE).strength(4.5F, 1200.0F).sound(SoundType.DEEPSLATE)));
    ...
    public static final DeferredBlock<Block> PALLADIUM_ORE = register("palladium_ore", () -> new DropExperienceBlock(ConstantInt.of(0), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(3.0F, 1200.0F)));
    public static final DeferredBlock<Block> DEEPSLATE_PALLADIUM_ORE = register("deepslate_palladium_ore", () -> new DropExperienceBlock(ConstantInt.of(0), BlockBehaviour.Properties.ofLegacyCopy(MarvelBlocks.PALLADIUM_ORE.get()).mapColor(MapColor.DEEPSLATE).strength(4.5F, 1200.0F).sound(SoundType.DEEPSLATE)));
