...
public class MarvelBlocks {
    ...
    public static final DeferredBlock<Block> VIBRANIUM_ORE = register("vibranium_ore", () -> new DropExperienceBlock(ConstantInt.of(0), BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(6.0F, 1200.0F)), () -> new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant());
    public static final DeferredBlock<Block> DEEPSLATE_VIBRANIUM_ORE = register("deepslate_vibranium_ore", () -> new DropExperienceBlock(ConstantInt.of(0), BlockBehaviour.Properties.ofLegacyCopy(MarvelBlocks.VIBRANIUM_ORE.get()).mapColor(MapColor.DEEPSLATE).strength(7.5F, 1200.0F).sound(SoundType.DEEPSLATE)), () -> new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant());
    public static final DeferredBlock<Block> VIBRANIUM_BLOCK = register("vibranium_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_MAGENTA).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).sound(SoundType.METAL)), () -> new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant());
    ...
    public static final DeferredBlock<Block> ADAMANTIUM_BLOCK = register("adamantium_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).sound(SoundType.METAL)), () -> new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant());
    public static final DeferredBlock<Block> PROTO_ADAMANTIUM_BLOCK = register("proto_adamantium_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).sound(SoundType.METAL)), () -> new Item.Properties().rarity(Rarity.UNCOMMON).fireResistant());
    public static final DeferredBlock<Block> URU_BLOCK = register("uru_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(50.0F, 1200.0F).sound(SoundType.METAL)), () -> new Item.Properties().rarity(Rarity.RARE).fireResistant());
    ...
    public static final DeferredBlock<Block> GREEN_HYDRA_BRICK_LAMP = register("green_hydra_brick_lamp", () -> new CopperBulbBlock(BlockBehaviour.Properties.ofFullCopy(GREEN_HYDRA_BRICKS.get()).lightLevel(state -> state.getValue(CopperBulbBlock.LIT) ? 15 : 9)));
    public static final DeferredBlock<Block> YELLOW_HYDRA_BRICKS = register("yellow_hydra_bricks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
    public static final DeferredBlock<Block> YELLOW_HYDRA_BRICK_SLAB = register("yellow_hydra_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(2.0F, 6.0F)));
    ...
    public static final DeferredBlock<Block> YELLOW_HYDRA_BRICK_LAMP = register("yellow_hydra_brick_lamp", () -> new CopperBulbBlock(BlockBehaviour.Properties.ofFullCopy(YELLOW_HYDRA_BRICKS.get()).lightLevel(state -> state.getValue(CopperBulbBlock.LIT) ? 15 : 9)));
    public static final DeferredBlock<Block> LIGHT_GRAY_HYDRA_BRICKS = register("light_gray_hydra_bricks", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.SNOW).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
    public static final DeferredBlock<Block> LIGHT_GRAY_HYDRA_BRICK_SLAB = register("light_gray_hydra_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SNOW).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(2.0F, 6.0F)));
    public static final DeferredBlock<Block> LIGHT_GRAY_HYDRA_BRICK_STAIRS = register("light_gray_hydra_brick_stairs", () -> new StairBlock(LIGHT_GRAY_HYDRA_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(LIGHT_GRAY_HYDRA_BRICKS.get())));
    public static final DeferredBlock<Block> LIGHT_GRAY_HYDRA_BRICK_WALL = register("light_gray_hydra_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(LIGHT_GRAY_HYDRA_BRICKS.get()).forceSolidOn()));
    public static final DeferredBlock<Block> LIGHT_GRAY_HYDRA_BRICK_LAMP = register("light_gray_hydra_brick_lamp", () -> new CopperBulbBlock(BlockBehaviour.Properties.ofFullCopy(LIGHT_GRAY_HYDRA_BRICKS.get()).lightLevel(state -> state.getValue(CopperBulbBlock.LIT) ? 15 : 9)));
    public static final DeferredBlock<Block> GRAY_HYDRA_BRICKS = register("gray_hydra_bricks", () -> new BossFloorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SNOW).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
    public static final DeferredBlock<Block> GRAY_HYDRA_BRICK_SLAB = register("gray_hydra_brick_slab", () -> new SlabBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SNOW).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops().strength(2.0F, 6.0F)));
    public static final DeferredBlock<Block> GRAY_HYDRA_BRICK_STAIRS = register("gray_hydra_brick_stairs", () -> new StairBlock(GRAY_HYDRA_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(GRAY_HYDRA_BRICKS.get())));
    public static final DeferredBlock<Block> GRAY_HYDRA_BRICK_WALL = register("gray_hydra_brick_wall", () -> new WallBlock(BlockBehaviour.Properties.ofFullCopy(GRAY_HYDRA_BRICKS.get()).forceSolidOn()));
    public static final DeferredBlock<Block> GRAY_HYDRA_BRICK_LAMP = register("gray_hydra_brick_lamp", () -> new CopperBulbBlock(BlockBehaviour.Properties.ofFullCopy(GRAY_HYDRA_BRICKS.get()).lightLevel(state -> state.getValue(CopperBulbBlock.LIT) ? 15 : 9)));
    public static final DeferredBlock<Block> STONE_BRICK_LAMP = register("stone_brick_lamp", () -> new CopperBulbBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICKS).lightLevel(state -> state.getValue(CopperBulbBlock.LIT) ? 15 : 9)));
    public static final DeferredBlock<Block> DEEPSLATE_BRICK_LAMP = register("deepslate_brick_lamp", () -> new CopperBulbBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE_BRICKS).lightLevel(state -> state.getValue(CopperBulbBlock.LIT) ? 15 : 9)));
    public static final DeferredBlock<Block> TESSERACT = registerBlockOnlyWithType("tesseract", () -> TesseractBlock.CODEC, () -> new TesseractBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_BLUE).instrument(NoteBlockInstrument.HAT).sound(SoundType.GLASS).emissiveRendering((state, getter, pos) -> true).lightLevel(state -> 10).strength(0.25F).pushReaction(PushReaction.NORMAL).explosionResistance(360000)));
