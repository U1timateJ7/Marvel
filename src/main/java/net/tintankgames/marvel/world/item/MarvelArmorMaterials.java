...
public class MarvelArmorMaterials {
    ...
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> IRON_MAN_DIAMOND = register("iron_man_diamond", () -> new ArmorMaterial(createArmorMap(3, 6, 8, 3, 11), 0, SoundEvents.ARMOR_EQUIP_IRON, () -> Ingredient.of(MarvelItems.TITANIUM_INGOT), List.of(new ArmorMaterial.Layer(MarvelSuperheroes.id("iron_man_mark_43"))), 2.0F, 0.0F));
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> IRON_MAN_NETHERITE = register("iron_man_netherite", () -> new ArmorMaterial(createArmorMap(3, 6, 8, 3, 11), 0, SoundEvents.ARMOR_EQUIP_IRON, () -> Ingredient.of(MarvelItems.TITANIUM_INGOT), List.of(new ArmorMaterial.Layer(MarvelSuperheroes.id("iron_man_mark_46"))), 3.0F, 0.1F));
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> IRON_MAN_MARK_85 = register("iron_man_mark_85", () -> new ArmorMaterial(createArmorMap(4, 7, 9, 4, 11), 0, SoundEvents.ARMOR_EQUIP_IRON, () -> Ingredient.of(MarvelItems.TITANIUM_INGOT), List.of(new ArmorMaterial.Layer(MarvelSuperheroes.id("iron_man_mark_85"))), 4.0F, 0.15F));
    ...
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> REINFORCED_LEATHER_NO_HELMET = register("reinforced_leather_no_helmet", () -> new ArmorMaterial(createArmorMap(4, 6, 7, 0, 11), 0, SoundEvents.ARMOR_EQUIP_LEATHER, () -> Ingredient.of(MarvelItems.REINFORCED_LEATHER), List.of(new ArmorMaterial.Layer(MarvelSuperheroes.id("reinforced_leather"))), 1.0F, 0.0F));
    ...
    public static final DeferredHolder<ArmorMaterial, ArmorMaterial> CAPTAIN_MARVEL = register("captain_marvel", () -> new ArmorMaterial(createArmorMap(3, 6, 8, 3, 11), 0, SoundEvents.ARMOR_EQUIP_LEATHER, () -> Ingredient.of(MarvelItems.REINFORCED_LEATHER), List.of(new ArmorMaterial.Layer(MarvelSuperheroes.id("captain_marvel")), new ArmorMaterial.Layer(MarvelSuperheroes.id("captain_marvel"), "_hair", true)), 2.0F, 0.0F));
