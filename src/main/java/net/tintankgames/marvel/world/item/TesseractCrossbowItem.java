...
public class TesseractCrossbowItem extends CrossbowItem {
    private static final CrossbowItem.ChargingSounds DEFAULT_SOUNDS = new CrossbowItem.ChargingSounds(
            Optional.of(MarvelSoundEvents.TESSERACT_CROSSBOW_LOADING_START), Optional.of(MarvelSoundEvents.TESSERACT_CROSSBOW_LOADING_MIDDLE), Optional.of(MarvelSoundEvents.TESSERACT_CROSSBOW_LOADING_END)
    );
    ...
    protected void shootProjectile(LivingEntity p_40896_, Projectile p_332122_, int p_331865_, float p_40900_, float p_40902_, float p_40903_, @Nullable LivingEntity p_330303_) {
        ...
        p_40896_.level().playSound(null, p_40896_.getX(), p_40896_.getY(), p_40896_.getZ(), MarvelSoundEvents.TESSERACT_CROSSBOW_SHOOT, p_40896_.getSoundSource(), 1.0F, f);
    }
    ...
    public void onUseTick(Level p_40910_, LivingEntity p_40911_, ItemStack p_40912_, int p_40913_) {
        if (!p_40910_.isClientSide) {
            ...
            if (f >= 0.5F && !this.midLoadSoundPlayed) {
                ...
                crossbowitem$chargingsounds.mid().or(DEFAULT_SOUNDS::mid)
                        .ifPresent(
