...
public class MarvelCreativeModeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> IRON_MAN_SUITS = register("iron_man_suits", builder -> builder.withTabsBefore(SUITS.getKey()).icon(MarvelItems.IRON_MAN_MARK_7_CHESTPLATE::toStack).displayItems((parameters, output) -> {
        ...
        output.accept(MarvelItems.IRON_MAN_MARK_23_HELMET);
        output.accept(MarvelItems.IRON_MAN_MARK_23_CHESTPLATE);
        output.accept(MarvelItems.IRON_MAN_MARK_23_LEGGINGS);
        output.accept(MarvelItems.IRON_MAN_MARK_23_BOOTS);
        output.accept(MarvelItems.IRON_MAN_MARK_24_HELMET);
        output.accept(MarvelItems.IRON_MAN_MARK_24_CHESTPLATE);
        output.accept(MarvelItems.IRON_MAN_MARK_24_LEGGINGS);
        output.accept(MarvelItems.IRON_MAN_MARK_24_BOOTS);
        output.accept(MarvelItems.IRON_MAN_MARK_25_HELMET);
        output.accept(MarvelItems.IRON_MAN_MARK_25_CHESTPLATE);
        output.accept(MarvelItems.IRON_MAN_MARK_25_LEGGINGS);
        output.accept(MarvelItems.IRON_MAN_MARK_25_BOOTS);
        output.accept(MarvelItems.IRON_MAN_MARK_28_HELMET);
        output.accept(MarvelItems.IRON_MAN_MARK_28_CHESTPLATE);
        output.accept(MarvelItems.IRON_MAN_MARK_28_LEGGINGS);
        output.accept(MarvelItems.IRON_MAN_MARK_28_BOOTS);
        output.accept(MarvelItems.IRON_MAN_MARK_30_HELMET);
        output.accept(MarvelItems.IRON_MAN_MARK_30_CHESTPLATE);
        output.accept(MarvelItems.IRON_MAN_MARK_30_LEGGINGS);
        output.accept(MarvelItems.IRON_MAN_MARK_30_BOOTS);
        output.accept(MarvelItems.IRON_MAN_MARK_33_HELMET);
