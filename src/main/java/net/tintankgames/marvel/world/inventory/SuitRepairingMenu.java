...
public class SuitRepairingMenu extends AbstractContainerMenu implements SuitTableMenu {
    ...
    protected static void slotChangedCraftingGrid(AbstractContainerMenu p_150547_, Level p_150548_, Player p_150549_, CraftingContainer p_150550_, ResultContainer p_150551_) {
        if (!p_150548_.isClientSide) {
            ...
            Optional<RecipeHolder<SuitRepairingRecipe>> optional = p_150548_.getServer().getRecipeManager().getRecipeFor(MarvelRecipeTypes.SUIT_REPAIRING.get(), p_150550_, p_150548_);
