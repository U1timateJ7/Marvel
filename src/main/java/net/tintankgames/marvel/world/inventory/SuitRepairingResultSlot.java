...
public class SuitRepairingResultSlot extends Slot {
    ...
    public void onTake(Player p_150638_, ItemStack p_150639_) {
        ...
        NonNullList<ItemStack> nonnulllist = p_150638_.level().getRecipeManager().getRemainingItemsFor(MarvelRecipeTypes.SUIT_REPAIRING.get(), this.craftSlots, p_150638_.level());
