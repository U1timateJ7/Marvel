...
public class SuitRepairingResultSlot extends Slot {
    private final CraftingContainer craftSlots;
    private final Player player;
    private int removeCount;

    public SuitRepairingResultSlot(Player p_40166_, CraftingContainer p_40167_, Container p_40168_, int p_40169_, int p_40170_, int p_40171_) {
    ...
    public void onTake(Player p_150638_, ItemStack p_150639_) {
        ...
        NonNullList<ItemStack> nonnulllist = p_150638_.level().getRecipeManager().getRemainingItemsFor(MarvelRecipeTypes.SUIT_REPAIRING.get(), this.craftSlots.asCraftInput(), p_150638_.level());
