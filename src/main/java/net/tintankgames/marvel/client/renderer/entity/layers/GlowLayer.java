...
public class GlowLayer<T extends LivingEntity, M extends HumanoidModel<T>> extends RenderLayer<T, M> {
    ...
    public void render(PoseStack p_117349_, MultiBufferSource p_117350_, int p_117351_, T p_117352_, float p_117353_, float p_117354_, float p_117355_, float p_117356_, float p_117357_, float p_117358_) {
        if (predicate.test(p_117352_)) renderColoredEmissiveModel(getParentModel(), texture, p_117349_, p_117350_, p_117351_, p_117352_, 1.0F, 1.0F, 1.0F);
    }

    public static <T extends LivingEntity> void renderColoredEmissiveModel(EntityModel<T> p_117377_, ResourceLocation p_117378_, PoseStack p_117379_, MultiBufferSource p_117380_, int p_117381_, T p_117382_, float p_350384_, float p_350385_, float p_350386_) {
        VertexConsumer vertexconsumer = p_117380_.getBuffer(MarvelRenderTypes.entityEmissive(p_117378_));
        p_117377_.renderToBuffer(p_117379_, vertexconsumer, p_117381_, LivingEntityRenderer.getOverlayCoords(p_117382_, 0.0F), p_350384_, p_350385_, p_350386_, 1.0F);
    }
}
