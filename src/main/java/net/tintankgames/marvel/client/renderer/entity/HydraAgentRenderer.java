...
public class HydraAgentRenderer extends MobRenderer<HydraAgent, PlayerModel<HydraAgent>> {
    ...
    private void setModelProperties(HydraAgent hydraAgent) {
        ...
        HumanoidModel.ArmPose mainHandPose = getArmPose(hydraAgent);
        HumanoidModel.ArmPose offHandPose = getArmPose(hydraAgent);
    ...
    private static HumanoidModel.ArmPose getArmPose(HydraAgent hydraAgent) {
    ...
    public ResourceLocation getTextureLocation(HydraAgent hydraAgent) {
        return hydraAgent.getVariant().value().texture();
    }
