...
public class RepulsorModel<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("shot", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -25.0F, -3.0F, 2.0F, 2.0F, 6.0F), PartPose.offset(0.0F, 24.0F, 0.0F));
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        shot.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }
}