...
public class VibraniumShieldModel extends Model {
    ...
    @Override
    public void renderToBuffer(PoseStack p_103919_, VertexConsumer p_103920_, int p_103921_, int p_103922_, int color) {
        this.root.render(p_103919_, p_103920_, p_103921_, p_103922_, color);
    }
}
