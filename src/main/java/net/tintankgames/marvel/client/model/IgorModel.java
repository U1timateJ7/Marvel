...
@OnlyIn(Dist.CLIENT)
public class IgorModel<T extends LivingEntity> extends HumanoidModel<T> {
    public IgorModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 21).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.26F)), PartPose.offset(0.0F, -5.75F, -6.0F));
        partdefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(75, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.51F)), PartPose.offset(0.0F, -5.75F, -6.0F));
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(50, 22).addBox(-5.0F, 1.0F, -2.5F, 10.0F, 6.0F, 5.0F).texOffs(50, 34).addBox(3.0F, -11.0F, -2.0F, 2.0F, 12.0F, 6.0F).texOffs(38, 52).addBox(-5.0F, -11.0F, -2.0F, 2.0F, 12.0F, 6.0F).texOffs(54, 52).addBox(-3.0F, -11.0F, -2.0F, 6.0F, 1.0F, 4.0F), PartPose.offset(0.0F, 0.0F, 0.0F));
        body.addOrReplaceChild("body2", CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -10.6192F, -4.7035F, 14.0F, 12.0F, 9.0F), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 0.1309F, 0.0F, 0.0F));
        partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(32, 21).addBox(-4.0F, -2.25F, -2.5F, 4.0F, 24.0F, 5.0F), PartPose.offset(-7.0F, -7.0F, -1.0F));
        partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(0, 37).addBox(0.0F, -2.25F, -2.5F, 4.0F, 24.0F, 5.0F), PartPose.offset(7.0F, -7.0F, -1.0F));
        partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(18, 50).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 17.0F, 5.0F), PartPose.offset(-3.5F, 7.0F, 0.0F));
        partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(50, 0).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 17.0F, 5.0F), PartPose.offset(3.5F, 7.0F, 0.0F));
    ...
    protected void setupAttackAnimation(T p_102858_, float p_102859_) {
        if (!(this.attackTime <= 0.0F)) {
            ...
            this.rightArm.z = Mth.sin(this.body.yRot) * 5.0F - 1;
            this.rightArm.x = -Mth.cos(this.body.yRot) * 7.0F;
            this.leftArm.z = -Mth.sin(this.body.yRot) * 5.0F - 1;
            this.leftArm.x = Mth.cos(this.body.yRot) * 7.0F;
