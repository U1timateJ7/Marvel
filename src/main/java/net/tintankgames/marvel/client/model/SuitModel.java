...
public class SuitModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createIronManMark25BodyLayer(ArmorItem.Type... types) {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();
        List<ArmorItem.Type> armorTypes = Arrays.asList(types);
        if (armorTypes.contains(ArmorItem.Type.HELMET)) {
        ...
        if (armorTypes.contains(ArmorItem.Type.CHESTPLATE)) {
            ...
            PartDefinition rightDrill = rightArm.addOrReplaceChild("rightDrill", CubeListBuilder.create().texOffs(44, 34).addBox(-1.5F, -6.375F, -2.625F, 5.0F, 8.0F, 5.0F).texOffs(17, 33).addBox(-1.5F, 1.625F, -2.625F, 3.0F, 1.0F, 5.0F).texOffs(31, 35).addBox(-1.5F, -10.375F, -2.625F, 1.0F, 4.0F, 5.0F), PartPose.offset(-3.3F, 11.375F, 0.125F));
            PartDefinition drillHead1 = rightDrill.addOrReplaceChild("drillHead1", CubeListBuilder.create().texOffs(0, 33).addBox(-1.5F, -3.0F, -0.5F, 3.0F, 4.0F, 0.0F), PartPose.offset(0.0F, 5.625F, 0.375F));
            drillHead1.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 33).addBox(-2.0F, -3.0F, 0.0F, 3.0F, 4.0F, 0.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
            ...
            PartDefinition leftDrill = leftArm.addOrReplaceChild("leftDrill", CubeListBuilder.create().texOffs(44, 34).mirror().addBox(-1.5F, -6.375F, -2.625F, 5.0F, 8.0F, 5.0F).mirror(false).texOffs(17, 33).mirror().addBox(0.5F, 1.625F, -2.625F, 3.0F, 1.0F, 5.0F).mirror(false).texOffs(31, 35).mirror().addBox(2.5F, -10.375F, -2.625F, 1.0F, 4.0F, 5.0F).mirror(false), PartPose.offset(1.3F, 11.375F, 0.125F));
            PartDefinition drillHead2 = leftDrill.addOrReplaceChild("drillHead2", CubeListBuilder.create().texOffs(0, 33).mirror().addBox(-1.5F, -2.0F, 0.0F, 3.0F, 4.0F, 0.0F).mirror(false), PartPose.offset(2.0F, 4.625F, -0.125F));
            drillHead2.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 33).mirror().addBox(-2.0F, -3.0F, -2.0F, 3.0F, 4.0F, 0.0F).mirror(false), PartPose.offsetAndRotation(-2.0F, 1.0F, 0.5F, 0.0F, -1.5708F, 0.0F));
        } else {
            partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.ZERO);
            partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.ZERO);
            partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.ZERO);
        ...
        if (armorTypes.contains(ArmorItem.Type.BOOTS)) {
            ...
            partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(48, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.51f)), PartPose.offset(-1.9F, 12.0F, 0.0F));
        } else if (!armorTypes.contains(ArmorItem.Type.LEGGINGS)) {
            partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create(), PartPose.ZERO);
            partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create(), PartPose.ZERO);
        }
    ...
    public static LayerDefinition createIronManCenturionBodyLayer(ArmorItem.Type... types) {
        MeshDefinition meshdefinition = new MeshDefinition();
        PartDefinition partdefinition = meshdefinition.getRoot();
        List<ArmorItem.Type> armorTypes = Arrays.asList(types);
        if (armorTypes.contains(ArmorItem.Type.HELMET)) {
        ...
        if (armorTypes.contains(ArmorItem.Type.CHESTPLATE)) {
            partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.27f)), PartPose.offset(0.0F, 0.0F, 0.0F));
            PartDefinition rightArm = partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.265f)).texOffs(58, 26).addBox(-4.0F, 6.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.265f)).texOffs(46, 32).addBox(-5.0F, -2.0F, -2.0F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.355F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
            rightArm.addOrReplaceChild("right_blade", CubeListBuilder.create().texOffs(35, 32).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 10.0F, 0.0F), PartPose.offset(-2.5F, -1.0F, 0.0F));
            PartDefinition leftArm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(32, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.26F)).texOffs(46, 32).mirror().addBox(0.0F, -2.0F, -2.0F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.35F)).mirror(false).texOffs(58, 26).mirror().addBox(3.0F, 6.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.26F)).mirror(false), PartPose.offset(5.0F, 2.0F, 0.0F));
            leftArm.addOrReplaceChild("left_blade", CubeListBuilder.create().texOffs(35, 32).mirror().addBox(-1.5F, 0.0F, 0.0F, 3.0F, 10.0F, 0.0F).mirror(false), PartPose.offset(2.5F, -1.0F, 0.0F));
        } else {
            partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.ZERO);
            partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.ZERO);
            partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.ZERO);
    ...
    public static void animate(PlayerTickEvent.Post event) {
        if (event.getEntity().level().isClientSide() && event.getEntity().tickCount > 20) {
            ...
            event.getEntity().getData(MarvelAttachmentTypes.DRILL_EQUIP_ANIMATION_STATE).animateWhen(event.getEntity().isHolding(MarvelItems.MINING_DRILL.get()), event.getEntity().tickCount);
            event.getEntity().getData(MarvelAttachmentTypes.DRILL_UNEQUIP_ANIMATION_STATE).animateWhen(!event.getEntity().isHolding(MarvelItems.MINING_DRILL.get()), event.getEntity().tickCount);
            event.getEntity().getData(MarvelAttachmentTypes.RIGHT_BLADE_EQUIP_ANIMATION_STATE).animateWhen(event.getEntity().getMainArm() == HumanoidArm.LEFT ? event.getEntity().getOffhandItem().is(MarvelItems.CENTURION_BLADE.get()) : event.getEntity().getMainHandItem().is(MarvelItems.CENTURION_BLADE.get()), event.getEntity().tickCount);
    ...
    public void animateArmor(LivingEntity living, float time) {
        ...
        this.animate(living.getData(MarvelAttachmentTypes.DRILL_EQUIP_ANIMATION_STATE), IronManAnimation.DRILL_EQUIP, time);
        this.animate(living.getData(MarvelAttachmentTypes.DRILL_UNEQUIP_ANIMATION_STATE), IronManAnimation.DRILL_UNEQUIP, time);
        this.animate(living.getData(MarvelAttachmentTypes.RIGHT_BLADE_EQUIP_ANIMATION_STATE), IronManAnimation.RIGHT_BLADE_EQUIP, time);
