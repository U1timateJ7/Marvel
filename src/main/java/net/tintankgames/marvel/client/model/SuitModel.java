...
public class SuitModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createWolverineBodyLayer(ArmorItem.Type... types) {
        ...
        if (armorTypes.contains(ArmorItem.Type.CHESTPLATE)) {
            ...
            PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(32, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.01F)).texOffs(46, 1).addBox(-1.0F, -2.0F, -2.0F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.02F)), PartPose.offset(5.0F, 2.0F, 0.0F));
