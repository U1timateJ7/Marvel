...
public class SpaceStoneParticle extends SimpleAnimatedParticle {
    ...
    protected SpaceStoneParticle(SpeedParticleOptions options, ClientLevel p_172094_, double p_172095_, double p_172096_, double p_172097_, double p_172098_, double p_172099_, double p_172100_, SpriteSet p_172102_) {
        ...
        int color = FastColor.ARGB32.colorFromFloat(1.0F, this.randomizeColor(FastColor.ARGB32.red(0x0992DB) / 255F, f), this.randomizeColor(FastColor.ARGB32.green(0x0992DB) / 255F, f), this.randomizeColor(FastColor.ARGB32.blue(0x0992DB) / 255F, f));
        setColor(color);
        int fadeColor = FastColor.ARGB32.colorFromFloat(1.0F, this.randomizeColor(FastColor.ARGB32.red(0x595959) / 255F, f), this.randomizeColor(FastColor.ARGB32.green(0x595959) / 255F, f), this.randomizeColor(FastColor.ARGB32.blue(0x595959) / 255F, f));
    ...
    public static class Provider implements ParticleProvider<SpeedParticleOptions> {
        ...
        public Particle createParticle(SpeedParticleOptions p_106443_, ClientLevel p_106444_, double p_106445_, double p_106446_, double p_106447_, double p_106448_, double p_106449_, double p_106450_) {
            return new SpaceStoneParticle(p_106443_, p_106444_, p_106445_, p_106446_, p_106447_, p_106448_, p_106449_, p_106450_, this.sprites);
        }
    }
}
