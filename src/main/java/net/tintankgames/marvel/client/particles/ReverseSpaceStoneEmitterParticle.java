...
public class ReverseSpaceStoneEmitterParticle extends NoRenderParticle {
    private final SpaceStoneParticleOptions options;

    ReverseSpaceStoneEmitterParticle(SpaceStoneParticleOptions options, ClientLevel p_106947_, double p_106948_, double p_106949_, double p_106950_) {
    ...
    public void tick() {
        for (int j = 0; j < 128; j++) {
            ...
            this.level.addAlwaysVisibleParticle(new SpeedParticleOptions(MarvelParticleTypes.REVERSE_SPACE_STONE.get(), options.speed()), d1, d2, d3, radius.x(), radius.y(), radius.z());
        }
    ...
    public static class Provider implements ParticleProvider<SpaceStoneParticleOptions> {
        public Particle createParticle(SpaceStoneParticleOptions p_106969_, ClientLevel p_106970_, double p_106971_, double p_106972_, double p_106973_, double p_106974_, double p_106975_, double p_106976_) {
            return new ReverseSpaceStoneEmitterParticle(p_106969_, p_106970_, p_106971_, p_106972_, p_106973_);
        }
    }
}
