...
public class IronManFlameParticle extends TextureSheetParticle {
    private IronManFlameParticle(ClientLevel p_106800_, double p_106801_, double p_106802_, double p_106803_, double p_106804_, double p_106805_, double p_106806_) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_106838_, ClientLevel p_106839_, double p_106840_, double p_106841_, double p_106842_, double p_106843_, double p_106844_, double p_106845_) {
            IronManFlameParticle ironManFlameParticle = new IronManFlameParticle(p_106839_, p_106840_, p_106841_, p_106842_, p_106843_, p_106844_, p_106845_);
            ironManFlameParticle.pickSprite(this.sprite);
            return ironManFlameParticle;
        }
    }
}
