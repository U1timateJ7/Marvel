...
package com.ulto.marvel.keybind;
...
public class AbilityKeyKeyBinding extends MarvelModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;
	public AbilityKeyKeyBinding(MarvelModElements instance) {
		super(instance, 231);
	...
	public void initElements() {
		keys = new KeyBinding("key.marvel.ability_key", GLFW.GLFW_KEY_C, "key.categories.misc");
		...
		if (type == 1) {
			{
				...
				WebShooterSwichProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
