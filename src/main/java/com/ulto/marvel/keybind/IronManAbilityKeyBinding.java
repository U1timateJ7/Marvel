...
public class IronManAbilityKeyBinding extends MarvelModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.marvel.iron_man_ability", GLFW.GLFW_KEY_V, "key.categories.misc");
