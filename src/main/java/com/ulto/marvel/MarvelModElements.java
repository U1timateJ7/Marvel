...
public class MarvelModElements {
	...
	public MarvelModElements() {
		sounds.put(new ResourceLocation("marvel", "item.vibranium_shield.throw"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("marvel", "item.vibranium_shield.throw")));
		sounds.put(new ResourceLocation("marvel", "item.vibranium_shield.hit"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("marvel", "item.vibranium_shield.hit")));
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == MarvelModElements.ModElement.class)
						elements.add((MarvelModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(MarvelModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new MarvelModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		MarvelMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final MarvelModElements elements;
		protected final int sortid;
		public ModElement(MarvelModElements elements, int sortid) {
