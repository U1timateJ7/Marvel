...
public class MarvelModParticles {
	...
	public static final SimpleParticleType IRON_MAN_FLIGHT = register(new SimpleParticleType(false).setRegistryName("iron_man_flight"),
			IronManFlightParticle::provider);
