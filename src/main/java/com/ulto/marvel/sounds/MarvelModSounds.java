...
public class MarvelModSounds {
	...
	static {
		SOUNDS.put(new ResourceLocation("marvel", "item.vibranium_shield.throw"),
				new SoundEvent(new ResourceLocation("marvel", "item.vibranium_shield.throw")));
		SOUNDS.put(new ResourceLocation("marvel", "item.vibranium_shield.hit"),
				new SoundEvent(new ResourceLocation("marvel", "item.vibranium_shield.hit")));
		SOUNDS.put(new ResourceLocation("marvel", "music.marvel.star_spangled_man"),
		...
		SOUNDS.put(new ResourceLocation("marvel", "item.antman.helmet_open"),
				new SoundEvent(new ResourceLocation("marvel", "item.antman.helmet_open")));
		SOUNDS.put(new ResourceLocation("marvel", "item.antman.helmet_close"),
		...
		SOUNDS.put(new ResourceLocation("marvel", "item.iron_man_helmet.nanotech_open"),
				new SoundEvent(new ResourceLocation("marvel", "item.iron_man_helmet.nanotech_open")));
		SOUNDS.put(new ResourceLocation("marvel", "item.iron_man_helmet.nanotech_close"),
				new SoundEvent(new ResourceLocation("marvel", "item.iron_man_helmet.nanotech_close")));
		SOUNDS.put(new ResourceLocation("marvel", "iron_man.mark50.suit_up"),
		...
		SOUNDS.put(new ResourceLocation("marvel", "iron_man.mark85.suit_up"),
				new SoundEvent(new ResourceLocation("marvel", "iron_man.mark85.suit_up")));
		SOUNDS.put(new ResourceLocation("marvel", "item.iron_spider_arms.deactivate"),
				new SoundEvent(new ResourceLocation("marvel", "item.iron_spider_arms.deactivate")));
		SOUNDS.put(new ResourceLocation("marvel", "item.iron_spider_arms.activate"),
				new SoundEvent(new ResourceLocation("marvel", "item.iron_spider_arms.activate")));
		SOUNDS.put(new ResourceLocation("marvel", "item.iron_spider_arms.attack"),
				new SoundEvent(new ResourceLocation("marvel", "item.iron_spider_arms.attack")));
		SOUNDS.put(new ResourceLocation("marvel", "item.stormbreaker.hit"),
				new SoundEvent(new ResourceLocation("marvel", "item.stormbreaker.hit")));
		SOUNDS.put(new ResourceLocation("marvel", "item.stormbreaker.catch"),
				new SoundEvent(new ResourceLocation("marvel", "item.stormbreaker.catch")));
		SOUNDS.put(new ResourceLocation("marvel", "item.mjolnir.hit_shield"),
		...
		SOUNDS.put(new ResourceLocation("marvel", "item.stormbreaker.throw"),
				new SoundEvent(new ResourceLocation("marvel", "item.stormbreaker.throw")));
		SOUNDS.put(new ResourceLocation("marvel", "item.adamantium_claws.retract"),
				new SoundEvent(new ResourceLocation("marvel", "item.adamantium_claws.retract")));
		SOUNDS.put(new ResourceLocation("marvel", "item.adamantium_claws.activate"),
