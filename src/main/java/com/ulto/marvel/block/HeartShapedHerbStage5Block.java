...
public class HeartShapedHerbStage5Block extends MarvelModElements.ModElement {
	@ObjectHolder("marvel:heart_shaped_herb_stage_5")
	public static final Block block = null;
	@ObjectHolder("marvel:heart_shaped_herb_stage_5")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public HeartShapedHerbStage5Block(MarvelModElements instance) {
		super(instance, 78);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("heart_shaped_herb_stage_5"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("heart_shaped_herb_stage_5");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("heart_shaped_herb_stage_5");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Heart Shaped Herb Stage 5");
		}
