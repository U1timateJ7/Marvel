...
public class HeartShapedHerbBlock extends MarvelModElements.ModElement {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!HeartShapedHerbAdditionalGenerationConditionProcedure.executeProcedure(ImmutableMap.of()))
						return false;
			...
			event.getRegistry().register(feature.setRegistryName("heart_shaped_herb"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("marvel:heart_shaped_herb"), configuredFeature);
		}
	}
	@SubscribeEvent
