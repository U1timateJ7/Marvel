...
public class HeartShapedHerbStage6Block extends MarvelModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("heart_shaped_herb_stage_6"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("heart_shaped_herb_stage_6");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("heart_shaped_herb_stage_6");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Heart Shaped Herb Stage 6");
		}
