...
public class VeronicaGuiScreen extends AbstractContainerScreen<VeronicaGuiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Veronica", 186, 7, -12829636);
		if (Mark21AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 166, 69, -16738048);
		if (Mark21UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 166, 69, -3407872);
		this.font.draw(poseStack, "Mark 21", 166, 60, -12829636);
		if (Mark23AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 22, 96, -16738048);
		if (Mark23UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 22, 96, -3407872);
		this.font.draw(poseStack, "Mark 23", 22, 87, -12829636);
		if (Mark30AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 310, 96, -16738048);
		if (Mark30UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 310, 96, -3407872);
		this.font.draw(poseStack, "Mark 30", 310, 87, -12829636);
		if (Mark42AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 22, 150, -16738048);
		if (Mark42UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 22, 150, -3407872);
		this.font.draw(poseStack, "Mark 42", 22, 141, -12829636);
		if (Mark46AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 310, 150, -16738048);
		if (Mark46UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 310, 150, -3407872);
		this.font.draw(poseStack, "Mark 46", 310, 141, -12829636);
		if (IronPatriotAvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 166, 177, -16738048);
		if (IronPatriotUnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 166, 177, -3407872);
		this.font.draw(poseStack, "Iron Patriot", 166, 168, -12829636);
		if (Mark22AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 310, 69, -16738048);
		if (Mark22UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 310, 69, -3407872);
		this.font.draw(poseStack, "Mark 22", 310, 60, -12829636);
		if (Mark25AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 166, 96, -16738048);
		if (Mark25UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 166, 96, -3407872);
		this.font.draw(poseStack, "Mark 25", 166, 87, -12829636);
		if (Mark33AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 22, 123, -16738048);
		if (Mark33UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 22, 123, -3407872);
		this.font.draw(poseStack, "Mark 33", 22, 114, -12829636);
		if (Mark43AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 166, 150, -16738048);
		if (Mark43UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 166, 150, -3407872);
		this.font.draw(poseStack, "Mark 43", 166, 141, -12829636);
		if (Mark47AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 22, 177, -16738048);
		if (Mark47UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 22, 177, -3407872);
		this.font.draw(poseStack, "Mark 47", 22, 168, -12829636);
		if (WarMachineAvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 310, 177, -16738048);
		if (WarMachineUnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 310, 177, -3407872);
		this.font.draw(poseStack, "War Machine", 310, 168, -12829636);
		if (Mark16AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 22, 42, -16738048);
		if (Mark16UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 22, 42, -3407872);
		this.font.draw(poseStack, "Mark 16", 22, 33, -12829636);
		if (Mark17AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 166, 42, -16738048);
		if (Mark17UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 166, 42, -3407872);
		this.font.draw(poseStack, "Mark 17", 166, 33, -12829636);
		if (Mark19AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 310, 42, -16738048);
		if (Mark19UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 310, 42, -3407872);
		this.font.draw(poseStack, "Mark 19", 310, 33, -12829636);
		if (Mark20AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 22, 69, -16738048);
		if (Mark20UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 22, 69, -3407872);
		this.font.draw(poseStack, "Mark 20", 22, 60, -12829636);
		if (Mark37AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 166, 123, -16738048);
		if (Mark37UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 166, 123, -3407872);
		this.font.draw(poseStack, "Mark 37", 166, 114, -12829636);
		if (Mark39AvailableProcedure.execute(entity))
			this.font.draw(poseStack, "Available", 310, 123, -16738048);
		if (Mark39UnavailableProcedure.execute(entity))
			this.font.draw(poseStack, "Unavailable", 310, 123, -3407872);
		this.font.draw(poseStack, "Mark 39", 310, 114, -12829636);
	}
