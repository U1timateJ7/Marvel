package com.ulto.marvel.client.input;
...
public class MarvelModKeyMappings {
	public static final KeyMapping TOGGLE_HELMET = new KeyMapping("key.marvel.toggle_helmet", GLFW.GLFW_KEY_H, "key.categories.marvel");
	public static final KeyMapping IRON_MAN_ABILITY = new KeyMapping("key.marvel.iron_man_ability", GLFW.GLFW_KEY_V, "key.categories.marvel");
	public static final KeyMapping ABILITY_KEY = new KeyMapping("key.marvel.ability_key", GLFW.GLFW_KEY_C, "key.categories.marvel");
	public static final KeyMapping SENTRY_MODE_KEY = new KeyMapping("key.marvel.sentry_mode_key", GLFW.GLFW_KEY_X, "key.categories.marvel");
