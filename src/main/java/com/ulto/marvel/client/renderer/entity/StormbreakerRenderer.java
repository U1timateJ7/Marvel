...
public class StormbreakerRenderer extends EntityRenderer<StormbreakerEntity> {
    private final ItemRenderer itemRenderer;
    private final float scale;
    private final boolean fullBright;

    public StormbreakerRenderer(EntityRendererProvider.Context p_174416_, float p_174417_, boolean p_174418_) {
        super(p_174416_);
    ...
    public StormbreakerRenderer(EntityRendererProvider.Context p_174414_) {
        this(p_174414_, 1.0F, false);
    }

    protected int getBlockLightLevel(StormbreakerEntity p_116092_, BlockPos p_116093_) {
        return this.fullBright ? 15 : super.getBlockLightLevel(p_116092_, p_116093_);
    }

    public void render(StormbreakerEntity p_116085_, float p_116086_, float p_116087_, PoseStack p_116088_, MultiBufferSource p_116089_, int p_116090_) {
        if (p_116085_.tickCount >= 2 || !(this.entityRenderDispatcher.camera.getEntity().distanceToSqr(p_116085_) < 12.25D)) {
            ...
            if (!p_116085_.isInGround()) p_116088_.mulPose(Vector3f.YP.rotationDegrees(24 * p_116085_.tickCount));
    ...
    public ResourceLocation getTextureLocation(StormbreakerEntity p_116083_) {
