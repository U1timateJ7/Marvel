...
public class ModelBodyCape<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("marvel", "model_body_cape"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Cape = Body
				.addOrReplaceChild(
						"Cape", CubeListBuilder.create().texOffs(0, 33).mirror()
