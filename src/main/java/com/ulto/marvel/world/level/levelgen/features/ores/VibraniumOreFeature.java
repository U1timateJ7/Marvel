...
public class VibraniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register(MarvelMod.MOD_ID + ":ore_vibranium", FEATURE,
				new OreConfiguration(ORE_VIBRANIUM_TARGET_LIST, 4, 0.5F)
		);
		Holder<PlacedFeature> LOWER = PlacementUtils.register(MarvelMod.MOD_ID + ":ore_vibranium", CONFIGURED_FEATURE, List.of(
