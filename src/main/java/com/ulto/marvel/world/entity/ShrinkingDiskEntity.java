...
public class ShrinkingDiskEntity extends AbstractArrow implements ItemSupplier {
	public ShrinkingDiskEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MarvelModEntityTypes.SHRINKING_DISK.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(MarvelModItems.SHRINKING_DISK.get());
	}
	...
	public static ShrinkingDiskEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		ShrinkingDiskEntity entityarrow = new ShrinkingDiskEntity(MarvelModEntityTypes.SHRINKING_DISK.get(), entity, world);
	...
	public static ShrinkingDiskEntity shoot(LivingEntity entity, LivingEntity target) {
		ShrinkingDiskEntity entityarrow = new ShrinkingDiskEntity(MarvelModEntityTypes.SHRINKING_DISK.get(), entity, entity.level);
