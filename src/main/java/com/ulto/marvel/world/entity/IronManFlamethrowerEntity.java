...
public class IronManFlamethrowerEntity extends AbstractArrow implements ItemSupplier {
	public IronManFlamethrowerEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MarvelModEntityTypes.FLAMETHROWER.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(MarvelModItems.FLAME.get());
	}
	...
	public static IronManFlamethrowerEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		IronManFlamethrowerEntity entityarrow = new IronManFlamethrowerEntity(MarvelModEntityTypes.FLAMETHROWER.get(), entity, world);
	...
	public static IronManFlamethrowerEntity shoot(LivingEntity entity, LivingEntity target) {
		IronManFlamethrowerEntity entityarrow = new IronManFlamethrowerEntity(MarvelModEntityTypes.FLAMETHROWER.get(), entity, entity.level);
