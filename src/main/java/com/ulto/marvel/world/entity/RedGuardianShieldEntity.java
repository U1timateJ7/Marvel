...
public class RedGuardianShieldEntity extends AbstractArrow implements ItemSupplier {
	public RedGuardianShieldEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MarvelModEntityTypes.RED_GUARDIAN_SHIELD.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(MarvelModItems.RED_GUARDIAN_SHIELD.get());
	}
	...
	public static RedGuardianShieldEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		RedGuardianShieldEntity entityarrow = new RedGuardianShieldEntity(MarvelModEntityTypes.RED_GUARDIAN_SHIELD.get(), entity, world);
	...
	public static RedGuardianShieldEntity shoot(LivingEntity entity, LivingEntity target) {
		RedGuardianShieldEntity entityarrow = new RedGuardianShieldEntity(MarvelModEntityTypes.RED_GUARDIAN_SHIELD.get(), entity, entity.level);
