...
public class WebShooterTrapEntity extends AbstractArrow implements ItemSupplier {
	public WebShooterTrapEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MarvelModEntityTypes.WEB_SHOOTER_TRAP.get(), world);
	}
	...
	public static WebShooterTrapEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		WebShooterTrapEntity entityarrow = new WebShooterTrapEntity(MarvelModEntityTypes.WEB_SHOOTER_TRAP.get(), entity, world);
	...
	public static WebShooterTrapEntity shoot(LivingEntity entity, LivingEntity target) {
		WebShooterTrapEntity entityarrow = new WebShooterTrapEntity(MarvelModEntityTypes.WEB_SHOOTER_TRAP.get(), entity, entity.level);
