...
public abstract class IronManMark43Item extends IronManSuitItem {
	public IronManMark43Item(EquipmentSlot slot, Item.Properties properties) {
		super(0.01388888888f, 0.02777777777f, MarvelModArmorMaterials.IRON_MAN_DIAMOND, slot, properties);
	}

	@Override
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_43");
	}

	public static class Helmet extends IronManMark43Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent(stack.getOrCreateTag().getBoolean("Open") ? "Mark XLIII - Open" : "Mark XLIII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark43_helmet_open.png" : "marvel:textures/mark43_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	...
	public static class Chestplate extends IronManMark43Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent("Mark XLIII"));
		}
	...
	public static class Leggings extends IronManMark43Item {
	...
	public static class Boots extends IronManMark43Item {
