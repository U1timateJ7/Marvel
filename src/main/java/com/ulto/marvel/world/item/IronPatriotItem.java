...
public abstract class IronPatriotItem extends IronManSuitItem {
	public IronPatriotItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "iron_patriot");
	}

	public static class Helmet extends IronPatriotItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/iron_patriot_helmet_open.png" : "marvel:textures/iron_patriot_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	...
	public static class Chestplate extends IronPatriotItem {
	...
	public static class Leggings extends IronPatriotItem {
	...
	public static class Boots extends IronPatriotItem {
