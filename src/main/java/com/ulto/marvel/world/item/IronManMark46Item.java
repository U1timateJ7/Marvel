...
public abstract class IronManMark46Item extends IronManSuitItem {
	public IronManMark46Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_46");
	}

	public static class Helmet extends IronManMark46Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent(stack.getOrCreateTag().getBoolean("Open") ? "Mark XLVI - Open" : "Mark XLVI"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark46_helmet_open.png" : "marvel:textures/mark46_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	...
	public static class Chestplate extends IronManMark46Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent("Mark XLVI"));
		}
	...
	public static class Leggings extends IronManMark46Item {
	...
	public static class Boots extends IronManMark46Item {
