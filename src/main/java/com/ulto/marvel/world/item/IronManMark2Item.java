...
public abstract class IronManMark2Item extends IronManSuitItem {
	public IronManMark2Item(EquipmentSlot slot, Item.Properties properties) {
		super(MarvelModArmorMaterials.IRON_MAN_IRON, slot, properties);
	}

	@Override
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_2");
	}
	...
	public static class Helmet extends IronManMark2Item {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark2_helmet_open.png" : "marvel:textures/mark2_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	}
