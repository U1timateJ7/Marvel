...
public class Mark50ArcReactorItem extends ArmorItem implements GlowingArmor {
	public Mark50ArcReactorItem(Item.Properties properties) {
	...
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return new ResourceLocation(MarvelMod.MOD_ID, "mark_50_arc_reactor");
	}
	...
	public ItemStack getDefaultInstance() {
		...
		armorList.addTag(0, MarvelModItems.IRON_MAN_MARK_50_BOOTS.get().getDefaultInstance().save(new CompoundTag()));
		armorList.addTag(1, MarvelModItems.IRON_MAN_MARK_50_LEGGINGS.get().getDefaultInstance().save(new CompoundTag()));
		armorList.addTag(2, MarvelModItems.IRON_MAN_MARK_50_CHESTPLATE.get().getDefaultInstance().save(new CompoundTag()));
		armorList.addTag(3, MarvelModItems.IRON_MAN_MARK_50_HELMET.get().getDefaultInstance().save(new CompoundTag()));
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
		return "marvel:textures/mark50_arc_reactor.png";
	}
}
