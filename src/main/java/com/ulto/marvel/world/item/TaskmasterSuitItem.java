...
import com.ulto.marvel.client.model.ModelTaskmasterHelmet;
...
public abstract class TaskmasterSuitItem extends ArmorItem {
	public TaskmasterSuitItem(EquipmentSlot slot, Item.Properties properties) {
		super(MarvelModArmorMaterials.REINFORCED_LEATHER, slot, properties);
	}

	public static class Helmet extends TaskmasterSuitItem {
			...
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head",
							new ModelTaskmasterHelmet(Minecraft.getInstance().getEntityModels().bakeLayer(ModelTaskmasterHelmet.LAYER_LOCATION)).mask,
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/taskmaster_helmet.png";
		}
	}

	public static class Chestplate extends TaskmasterSuitItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/taskmaster_layer_1.png";
		}
	}

	public static class Leggings extends TaskmasterSuitItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/taskmaster_layer_2.png";
		}
	}

	public static class Boots extends TaskmasterSuitItem {
