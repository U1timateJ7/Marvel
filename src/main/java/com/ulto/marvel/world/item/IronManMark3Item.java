...
public abstract class IronManMark3Item extends IronManSuitItem {
	public IronManMark3Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_3");
	}

	public static class Helmet extends IronManMark3Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent(stack.getOrCreateTag().getBoolean("Open") ? "Mark III - Open" : "Mark III"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark3_helmet_open.png" : "marvel:textures/mark3_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	}

	public static class Chestplate extends IronManMark3Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent("Mark III"));
		}
	...
	public static class Leggings extends IronManMark3Item {
	...
	public static class Boots extends IronManMark3Item {
