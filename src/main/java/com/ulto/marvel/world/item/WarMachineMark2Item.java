...
import com.ulto.marvel.client.model.WarMachineModel;
...
public abstract class WarMachineMark2Item extends IronManSuitItem {
	public WarMachineMark2Item(EquipmentSlot slot, Item.Properties properties) {
		super(0.01388888888f, 0.02777777777f, MarvelModArmorMaterials.IRON_MAN_NETHERITE, slot, properties);
	}
	...
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "war_machine_mark_2");
	}

	public static class Helmet extends WarMachineMark2Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent(stack.getOrCreateTag().getBoolean("Open") ? "Mark II - Open" : "Mark II"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/war_machine_mark_2_helmet_open.png" : "marvel:textures/war_machine_mark_2_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	}

	public static class Chestplate extends WarMachineMark2Item {
			...
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body",
							new WarMachineModel(Minecraft.getInstance().getEntityModels().bakeLayer(MarvelModModels.WAR_MACHINE)).Body, "left_arm",
							new WarMachineModel(Minecraft.getInstance().getEntityModels().bakeLayer(MarvelModModels.WAR_MACHINE)).LeftArm,
							"right_arm",
							new WarMachineModel(Minecraft.getInstance().getEntityModels().bakeLayer(MarvelModModels.WAR_MACHINE)).RightArm, "head",
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent("Mark II"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/war_machine_mark_2_layer_1.png";
		}
	...
	public static class Leggings extends WarMachineMark2Item {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/war_machine_mark_2_layer_2.png";
		}
	}

	public static class Boots extends WarMachineMark2Item {
