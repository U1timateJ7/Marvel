...
import com.ulto.marvel.procedures.IronManMark47LeggingsTickEventProcedure;
...
public abstract class IronManMark47Item extends IronManSuitItem {
	public IronManMark47Item(EquipmentSlot slot, Item.Properties properties) {
		super(0.01388888888f, 0.02777777777f, MarvelModArmorMaterials.IRON_MAN_3, slot, properties);
	}

	@Override
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_47");
	}

	public static class Helmet extends IronManMark47Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent(stack.getOrCreateTag().getBoolean("Open") ? "Mark XLVII - Open" : "Mark XLVII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark47_helmet_open.png" : "marvel:textures/mark47_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	...
	public static class Chestplate extends IronManMark47Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent("Mark XLVII"));
		}
	...
	public static class Leggings extends IronManMark47Item {
		...
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			super.onArmorTick(itemstack, world, entity);
			IronManMark47LeggingsTickEventProcedure.execute(entity);
		}
	}

	public static class Boots extends IronManMark47Item {
