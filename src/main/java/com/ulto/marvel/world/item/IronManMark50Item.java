...
public abstract class IronManMark50Item extends IronManSuitItem {
	public IronManMark50Item(EquipmentSlot slot, Item.Properties properties) {
		super(0.01388888888f, 0.02777777777f, MarvelModArmorMaterials.IRON_MAN_DIAMOND_PLUS, slot, properties);
	}

	@Override
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_50");
	}
	...
	public static class Helmet extends IronManMark50Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent(stack.getOrCreateTag().getBoolean("Open") ? "Mark L - Open" : "Mark L"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark50_helmet_open.png" : "marvel:textures/mark50_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	...
	public static class Chestplate extends IronManMark50Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent("Mark L"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/mark50_layer_1.png";
		}
	...
	public static class Leggings extends IronManMark50Item {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/mark50_layer_2.png";
		}
	}

	public static class Boots extends IronManMark50Item {
