...
public abstract class IronManMark16Item extends IronManSuitItem {
	...
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : stack.getOrCreateTag().getBoolean("Invisible") ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_16");
	}
	...
	public static class Helmet extends IronManMark16Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent((stack.getOrCreateTag().getBoolean("Open") ? "Mark XVI - Open" : "Mark XVI") + (stack.getOrCreateTag().getBoolean("Invisible") ? " - Invisible" : "")));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Invisible") ? "marvel:textures/models/armor/empty_layer_1.png" : stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark16_helmet_open.png" : "marvel:textures/mark16_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	...
	public static class Chestplate extends IronManMark16Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent(("Mark XVI") + (stack.getOrCreateTag().getBoolean("Invisible") ? " - Invisible" : "")));
		}
