...
public abstract class IronManMark5Item extends IronManSuitItem {
	public IronManMark5Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public ResourceLocation getGlowTexture(ItemStack stack, @Nullable Entity entity, @Nullable EquipmentSlot slot) {
		return getBattery(stack) == 0 ? null : new ResourceLocation(MarvelMod.MOD_ID, "mark_5");
	}

	public static class Helmet extends IronManMark5Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			...
			components.add(new TextComponent(stack.getOrCreateTag().getBoolean("Open") ? "Mark V - Open" : "Mark V"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark5_helmet_open.png" : "marvel:textures/mark5_helmet" + (type == null ? "" : "_" + type) + ".png";
		}
	}

	public static class Chestplate extends IronManMark5Item {
		...
		public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag flag) {
			super.appendHoverText(stack, level, components, flag);
			components.add(new TextComponent("Mark V"));
		}
	...
	public static class Leggings extends IronManMark5Item {
	...
	public static class Boots extends IronManMark5Item {
