...
public class VeronicaGuiGui extends MarvelModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public VeronicaGuiGui(MarvelModElements instance) {
		super(instance, 309);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("veronica_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, VeronicaGuiGuiWindow::new));
	}
		...
		if (buttonID == 12) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HousePartyProtocolProcedure.executeProcedure($_dependencies);
			}
		}
	}
