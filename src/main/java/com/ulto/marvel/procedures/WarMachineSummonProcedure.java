...
public class WarMachineSummonProcedure {
	public static void execute(LevelAccessor world, double x, double z, Entity entity) {
		...
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
			...
			if (_entity instanceof Player _player)
				_player.getInventory().armor.set(2, new ItemStack(MarvelModItems.WAR_MACHINE_MARK_2_CHESTPLATE));
			else
				_entity.setItemSlot(EquipmentSlot.CHEST, new ItemStack(MarvelModItems.WAR_MACHINE_MARK_2_CHESTPLATE));
			if (_entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.getInventory().setChanged();
		}
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
			...
			if (_entity instanceof Player _player)
				_player.getInventory().armor.set(1, new ItemStack(MarvelModItems.WAR_MACHINE_MARK_2_LEGGINGS));
			else
				_entity.setItemSlot(EquipmentSlot.LEGS, new ItemStack(MarvelModItems.WAR_MACHINE_MARK_2_LEGGINGS));
			if (_entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.getInventory().setChanged();
		}
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
			...
			if (_entity instanceof Player _player)
				_player.getInventory().armor.set(0, new ItemStack(MarvelModItems.WAR_MACHINE_MARK_2_BOOTS));
			else
				_entity.setItemSlot(EquipmentSlot.FEET, new ItemStack(MarvelModItems.WAR_MACHINE_MARK_2_BOOTS));
			if (_entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.getInventory().setChanged();
		}
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
