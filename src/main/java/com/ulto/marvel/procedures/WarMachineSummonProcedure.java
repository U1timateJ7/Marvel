...
public class WarMachineSummonProcedure extends MarvelModElements.ModElement {
	public WarMachineSummonProcedure(MarvelModElements instance) {
		super(instance, 359);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MarvelMod.LOGGER.warn("Failed to load dependency entity for procedure WarMachineSummon!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MarvelMod.LOGGER.warn("Failed to load dependency x for procedure WarMachineSummon!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MarvelMod.LOGGER.warn("Failed to load dependency z for procedure WarMachineSummon!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MarvelMod.LOGGER.warn("Failed to load dependency world for procedure WarMachineSummon!");
			return;
		}
				...
				((PlayerEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								new ItemStack(WarMachineMark2Item.body, (int) (1)));
			else
				((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
						.stream().sorted(new Object() {
				...
				((PlayerEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								new ItemStack(WarMachineMark2Item.legs, (int) (1)));
			else
				((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
						.stream().sorted(new Object() {
				...
				((PlayerEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								new ItemStack(WarMachineMark2Item.boots, (int) (1)));
			else
				((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
						.stream().sorted(new Object() {
