...
public class Mark23SummonProcedure {
	public static void execute(LevelAccessor world, double x, double z, Entity entity) {
		...
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
			...
			if (_entity instanceof Player _player)
				_player.getInventory().armor.set(2, new ItemStack(MarvelModItems.IRON_MAN_MARK_23_CHESTPLATE));
			else
				_entity.setItemSlot(EquipmentSlot.CHEST, new ItemStack(MarvelModItems.IRON_MAN_MARK_23_CHESTPLATE));
			if (_entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.getInventory().setChanged();
		}
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
			...
			if (_entity instanceof Player _player)
				_player.getInventory().armor.set(1, new ItemStack(MarvelModItems.IRON_MAN_MARK_23_LEGGINGS));
			else
				_entity.setItemSlot(EquipmentSlot.LEGS, new ItemStack(MarvelModItems.IRON_MAN_MARK_23_LEGGINGS));
			if (_entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.getInventory().setChanged();
		}
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
			...
			if (_entity instanceof Player _player)
				_player.getInventory().armor.set(0, new ItemStack(MarvelModItems.IRON_MAN_MARK_23_BOOTS));
			else
				_entity.setItemSlot(EquipmentSlot.FEET, new ItemStack(MarvelModItems.IRON_MAN_MARK_23_BOOTS));
			if (_entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.getInventory().setChanged();
		}
		if (((Entity) world.getEntitiesOfClass(SentryModeEntity.class, AABB.ofSize(new Vec3(x2, 255, z2), 1, 1, 1), e -> true).stream()
