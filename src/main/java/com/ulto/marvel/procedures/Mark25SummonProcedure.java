...
public class Mark25SummonProcedure extends MarvelModElements.ModElement {
	public Mark25SummonProcedure(MarvelModElements instance) {
		super(instance, 343);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MarvelMod.LOGGER.warn("Failed to load dependency entity for procedure Mark25Summon!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MarvelMod.LOGGER.warn("Failed to load dependency x for procedure Mark25Summon!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MarvelMod.LOGGER.warn("Failed to load dependency z for procedure Mark25Summon!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MarvelMod.LOGGER.warn("Failed to load dependency world for procedure Mark25Summon!");
			return;
		}
		...
		if (((Entity) world
			...
			((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
					...
					}.compareDistOf((x2), 255, (z2))).findFirst().orElse(null))).setHeldItem(Hand.MAIN_HAND, _setstack);
			if (((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
					new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
					.stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
		...
		if (((Entity) world
			...
			((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
					...
					}.compareDistOf((x2), 255, (z2))).findFirst().orElse(null))).setHeldItem(Hand.OFF_HAND, _setstack);
			if (((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
					new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
					.stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
