	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MarvelMod.LOGGER.warn("Failed to load dependency entity for procedure BloodyVibraniumShieldRangedItemUsed!");
			return;
		}
		...
		if ((new Object() {
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _stktoremove = new ItemStack(BloodyVibraniumShieldItem.block, (int) (1));
