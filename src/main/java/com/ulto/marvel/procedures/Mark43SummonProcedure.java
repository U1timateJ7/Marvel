...
public class Mark43SummonProcedure extends MarvelModElements.ModElement {
	public Mark43SummonProcedure(MarvelModElements instance) {
		super(instance, 351);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MarvelMod.LOGGER.warn("Failed to load dependency entity for procedure Mark43Summon!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MarvelMod.LOGGER.warn("Failed to load dependency x for procedure Mark43Summon!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MarvelMod.LOGGER.warn("Failed to load dependency z for procedure Mark43Summon!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MarvelMod.LOGGER.warn("Failed to load dependency world for procedure Mark43Summon!");
			return;
		}
				...
				((PlayerEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								new ItemStack(IronManMark43Item.body, (int) (1)));
			else
				((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
						.stream().sorted(new Object() {
				...
				((PlayerEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								new ItemStack(IronManMark43Item.legs, (int) (1)));
			else
				((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
						.stream().sorted(new Object() {
				...
				((PlayerEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						...
						.stream().sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								...
								new ItemStack(IronManMark43Item.boots, (int) (1)));
			else
				((LivingEntity) ((Entity) world.getEntitiesWithinAABB(SentryModeEntity.CustomEntity.class,
						new AxisAlignedBB((x2) - (1 / 2d), 255 - (1 / 2d), (z2) - (1 / 2d), (x2) + (1 / 2d), 255 + (1 / 2d), (z2) + (1 / 2d)), null)
						.stream().sorted(new Object() {
