...
public class StormbreakerEntity extends AbstractArrow implements ItemSupplier {
	public StormbreakerEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(MarvelModEntities.STORMBREAKER, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(MarvelModItems.STORMBREAKER);
	}
	...
	public static StormbreakerEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		StormbreakerEntity entityarrow = new StormbreakerEntity(MarvelModEntities.STORMBREAKER, entity, world);
	...
	public static StormbreakerEntity shoot(LivingEntity entity, LivingEntity target) {
		StormbreakerEntity entityarrow = new StormbreakerEntity(MarvelModEntities.STORMBREAKER, entity, entity.level);
