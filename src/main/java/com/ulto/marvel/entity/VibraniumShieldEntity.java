...
public class VibraniumShieldEntity extends AbstractArrow implements ItemSupplier {
	public VibraniumShieldEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(MarvelModEntities.VIBRANIUM_SHIELD, world);
	}
	...
	public static VibraniumShieldEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		VibraniumShieldEntity entityarrow = new VibraniumShieldEntity(MarvelModEntities.VIBRANIUM_SHIELD, entity, world);
	...
	public static VibraniumShieldEntity shoot(LivingEntity entity, LivingEntity target) {
		VibraniumShieldEntity entityarrow = new VibraniumShieldEntity(MarvelModEntities.VIBRANIUM_SHIELD, entity, entity.level);
