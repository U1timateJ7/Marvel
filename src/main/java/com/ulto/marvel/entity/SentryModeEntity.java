...
public class SentryModeEntity extends TamableAnimal implements RangedAttackMob {
	public SentryModeEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(MarvelModEntities.SENTRY_MODE, world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SentryModeEntity retval = MarvelModEntities.SENTRY_MODE.create(serverWorld);
