...
public abstract class IronManMark21Item extends ArmorItem {
	public IronManMark21Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark21Item {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XXI - Open" : "Mark XXI"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark21_open.png" : "marvel:textures/mark21_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark21Item {
		public Chestplate() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XXI"));
		}
	...
	public static class Leggings extends IronManMark21Item {
		public Leggings() {
	...
	public static class Boots extends IronManMark21Item {
		public Boots() {
