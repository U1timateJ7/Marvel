...
public class IronManFlamethrowerItem extends MarvelModElements.ModElement {
	@ObjectHolder("marvel:flamethrower")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletflamethrower").setRegistryName("entitybulletflamethrower"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FlameItem.block, (int) (1));
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				IronManFlamethrowerBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					IronManFlamethrowerBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
