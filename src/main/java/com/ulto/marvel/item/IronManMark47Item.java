...
public abstract class IronManMark47Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark47Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XLVII - Open" : "Mark XLVII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark47_open.png" : "marvel:textures/mark47_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark47Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XLVII"));
		}
