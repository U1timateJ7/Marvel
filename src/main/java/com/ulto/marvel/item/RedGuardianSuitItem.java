...
public abstract class RedGuardianSuitItem extends ArmorItem {
	public RedGuardianSuitItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends RedGuardianSuitItem {
		public Helmet() {
	...
	public static class Chestplate extends RedGuardianSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends RedGuardianSuitItem {
		public Leggings() {
	...
	public static class Boots extends RedGuardianSuitItem {
		public Boots() {
