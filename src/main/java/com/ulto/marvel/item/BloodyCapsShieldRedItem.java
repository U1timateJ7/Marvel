...
public class BloodyCapsShieldRedItem extends MarvelModElements.ModElement {
	@ObjectHolder("marvel:bloody_captain_americas_shield_red")
	public static final Item block = null;
	@ObjectHolder("marvel:entitybulletbloody_captain_americas_shield_red")
	public static final EntityType arrow = null;
	public BloodyCapsShieldRedItem(MarvelModElements instance) {
		super(instance, 104);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletbloody_captain_americas_shield_red")
						.setRegistryName("entitybulletbloody_captain_americas_shield_red"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("bloody_captain_americas_shield_red");
		}
