...
public abstract class IronManMark6Item extends ArmorItem {
	public IronManMark6Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark6Item {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark VI - Open" : "Mark VI"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark6_open.png" : "marvel:textures/mark6_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark6Item {
		public Chestplate() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark VI"));
		}
	...
	public static class Leggings extends IronManMark6Item {
		public Leggings() {
	...
	public static class Boots extends IronManMark6Item {
		public Boots() {
