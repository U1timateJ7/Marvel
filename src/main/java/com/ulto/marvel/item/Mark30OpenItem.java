...
public abstract class Mark30OpenItem extends ArmorItem {
	public Mark30OpenItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends Mark30OpenItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("Mark XXX - Open"));
		}
