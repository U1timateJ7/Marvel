...
public abstract class Mark85ArcReactorItem extends ArmorItem {
	public Mark85ArcReactorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Mark85ArcReactorItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_ITEMS));
			setRegistryName("mark_85_arc_reactor_chestplate");
		}
