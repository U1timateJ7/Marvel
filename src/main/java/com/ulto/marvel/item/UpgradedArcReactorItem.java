...
public class UpgradedArcReactorItem extends MarvelModElements.ModElement {
	@ObjectHolder("marvel:upgraded_arc_reactor")
	public static final Item block = null;
	public UpgradedArcReactorItem(MarvelModElements instance) {
		super(instance, 21);
	}
