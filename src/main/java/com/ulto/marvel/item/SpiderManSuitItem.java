...
public abstract class SpiderManSuitItem extends ArmorItem {
	public SpiderManSuitItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SpiderManSuitItem {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("spider_man_suit_helmet");
		}
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/spiderman_helmet.png";
		}
	}

	public static class Chestplate extends SpiderManSuitItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("spider_man_suit_chestplate");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/spiderman_layer_1.png";
		}
	}

	public static class Leggings extends SpiderManSuitItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("spider_man_suit_leggings");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/spiderman_layer_2.png";
		}
	}

	public static class Boots extends SpiderManSuitItem {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("spider_man_suit_boots");
		}
