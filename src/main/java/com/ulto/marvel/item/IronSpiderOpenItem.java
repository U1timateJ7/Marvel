...
public abstract class IronSpiderOpenItem extends ArmorItem {
	public IronSpiderOpenItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronSpiderOpenItem {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(null));
			setRegistryName("iron_spider_open_helmet");
		}
