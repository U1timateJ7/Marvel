...
public abstract class Mark47OpenItem extends ArmorItem {
	public Mark47OpenItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends Mark47OpenItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("Mark XLVII - Open"));
		}
