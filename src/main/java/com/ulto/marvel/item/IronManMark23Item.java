...
public abstract class IronManMark23Item extends ArmorItem {
	public IronManMark23Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark23Item {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XXIII - Open" : "Mark XXIII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark23_open.png" : "marvel:textures/mark23_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark23Item {
		public Chestplate() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XXIII"));
		}
	...
	public static class Leggings extends IronManMark23Item {
		public Leggings() {
	...
	public static class Boots extends IronManMark23Item {
		public Boots() {
