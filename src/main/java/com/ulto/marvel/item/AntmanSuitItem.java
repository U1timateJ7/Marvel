...
public abstract class AntmanSuitItem extends ArmorItem {
	public AntmanSuitItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends AntmanSuitItem {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("antman_suit_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			if (itemstack.getOrCreateTag().getBoolean("Open")) list.add(new TextComponent("Open"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/antman_open.png" : "marvel:textures/antman_helmet.png";
		}
	}

	public static class Chestplate extends AntmanSuitItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("antman_suit_chestplate");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/antman_layer_1.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			AntmanGiveItemsProcedure.execute(world, entity);
		}
	}

	public static class Leggings extends AntmanSuitItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("antman_suit_leggings");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/antman_layer_2.png";
		}
	}

	public static class Boots extends AntmanSuitItem {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("antman_suit_boots");
		}
