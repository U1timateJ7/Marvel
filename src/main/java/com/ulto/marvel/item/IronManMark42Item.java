...
public abstract class IronManMark42Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark42Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XLII - Open" : "Mark XLII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark42_open.png" : "marvel:textures/mark42_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark42Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XLII"));
		}
