...
public abstract class CaptainAmericaSuitItem extends ArmorItem {
	public CaptainAmericaSuitItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends CaptainAmericaSuitItem {
		public Helmet() {
	...
	public static class Chestplate extends CaptainAmericaSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends CaptainAmericaSuitItem {
		public Leggings() {
	...
	public static class Boots extends CaptainAmericaSuitItem {
		public Boots() {
