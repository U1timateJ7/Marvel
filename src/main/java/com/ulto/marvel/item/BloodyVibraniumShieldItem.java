...
public class BloodyVibraniumShieldItem extends MarvelModElements.ModElement {
	@ObjectHolder("marvel:bloody_vibranium_shield")
	public static final Item block = null;
	@ObjectHolder("marvel:entitybulletbloody_vibranium_shield")
	public static final EntityType arrow = null;
	public BloodyVibraniumShieldItem(MarvelModElements instance) {
		super(instance, 103);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletbloody_vibranium_shield").setRegistryName("entitybulletbloody_vibranium_shield"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("bloody_vibranium_shield");
		}
