...
public abstract class IronManMark16Item extends ArmorItem {
	public IronManMark16Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark16Item {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_16_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent((itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XVI - Open" : "Mark XVI") + (itemstack.getOrCreateTag().getBoolean("Invisible") ? " - Invisible" : "")));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Invisible") ? "marvel:textures/models/armor/empty_layer_1.png" : stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark16_open.png" : "marvel:textures/mark16_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark16Item {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_16_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent(("Mark XVI") + (itemstack.getOrCreateTag().getBoolean("Invisible") ? " - Invisible" : "")));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Invisible") ? "marvel:textures/models/armor/empty_layer_1.png" : "marvel:textures/mark16_layer_1.png";
		}
	...
	public static class Leggings extends IronManMark16Item {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_16_leggings");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Invisible") ? "marvel:textures/models/armor/empty_layer_2.png" : "marvel:textures/mark16_layer_2.png";
		}
	}

	public static class Boots extends IronManMark16Item {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_16_boots");
		}
