...
public abstract class CaptainAmericaStealthSuitItem extends ArmorItem {
	public CaptainAmericaStealthSuitItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(MarvelModItems.REINFORCED_LEATHER));
			}
	...
	public static class Helmet extends CaptainAmericaStealthSuitItem {
		public Helmet() {
	...
	public static class Chestplate extends CaptainAmericaStealthSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends CaptainAmericaStealthSuitItem {
		public Leggings() {
	...
	public static class Boots extends CaptainAmericaStealthSuitItem {
		public Boots() {
