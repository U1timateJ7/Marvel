...
public abstract class IronManMark85Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark85Item {
		public Helmet() {
			...
			setRegistryName("iron_man_mark_85_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark LXXXV - Open" : "Mark LXXXV"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/models/armor/empty_layer_1.png" : "marvel:textures/mark85_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark85Item {
		public Chestplate() {
			...
			setRegistryName("iron_man_mark_85_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark LXXXV"));
		}
	...
	public static class Leggings extends IronManMark85Item {
		public Leggings() {
			...
			setRegistryName("iron_man_mark_85_leggings");
		}
	...
	public static class Boots extends IronManMark85Item {
		public Boots() {
			...
			setRegistryName("iron_man_mark_85_boots");
		}
