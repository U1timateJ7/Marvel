...
public abstract class WarMachineMark2Item extends ArmorItem {
	public WarMachineMark2Item(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(MarvelModItems.TITANIUM_INGOT));
			}
	...
	public static class Helmet extends WarMachineMark2Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark II - Open" : "Mark II"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/warmachine_v2_open.png" : "marvel:textures/warmachine_v2_helmet.png";
		}
	}
	...
	public static class Chestplate extends WarMachineMark2Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark II"));
		}
