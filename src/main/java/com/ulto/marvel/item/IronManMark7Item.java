...
public abstract class IronManMark7Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark7Item {
		public Helmet() {
			...
			setRegistryName("iron_man_mark_7_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark VII - Open" : "Mark VII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark7_open.png" : "marvel:textures/mark7_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark7Item {
		public Chestplate() {
			...
			setRegistryName("iron_man_mark_7_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark VII"));
		}
	...
	public static class Leggings extends IronManMark7Item {
		public Leggings() {
			...
			setRegistryName("iron_man_mark_7_leggings");
		}
	...
	public static class Boots extends IronManMark7Item {
		public Boots() {
			...
			setRegistryName("iron_man_mark_7_boots");
		}
