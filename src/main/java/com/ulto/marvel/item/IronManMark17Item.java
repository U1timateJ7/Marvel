...
public abstract class IronManMark17Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark17Item {
		public Helmet() {
			...
			setRegistryName("iron_man_mark_17_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XVII - Open" : "Mark XVII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark17_open.png" : "marvel:textures/mark17_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark17Item {
		public Chestplate() {
			...
			setRegistryName("iron_man_mark_17_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XVII"));
		}
	...
	public static class Leggings extends IronManMark17Item {
		public Leggings() {
			...
			setRegistryName("iron_man_mark_17_leggings");
		}
	...
	public static class Boots extends IronManMark17Item {
		public Boots() {
			...
			setRegistryName("iron_man_mark_17_boots");
		}
