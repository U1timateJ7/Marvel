...
public abstract class IronManMark49Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark49Item {
		public Helmet() {
			...
			setRegistryName("iron_man_mark_49_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XLIX - Open" : "Mark XLIX"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/models/armor/empty_layer_1.png" : "marvel:textures/mark49_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark49Item {
		public Chestplate() {
			...
			setRegistryName("iron_man_mark_49_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XLIX"));
		}
	...
	public static class Leggings extends IronManMark49Item {
		public Leggings() {
			...
			setRegistryName("iron_man_mark_49_leggings");
		}
	...
	public static class Boots extends IronManMark49Item {
		public Boots() {
			...
			setRegistryName("iron_man_mark_49_boots");
		}
