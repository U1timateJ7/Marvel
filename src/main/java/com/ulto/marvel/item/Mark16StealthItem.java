...
public abstract class Mark16StealthItem extends ArmorItem {
	public Mark16StealthItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends Mark16StealthItem {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(null));
			setRegistryName("mark_16_stealth_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("Mark XVI - Invisible"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/models/armor/empty_layer_1.png";
		}
	...
	public static class Chestplate extends Mark16StealthItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(null));
			setRegistryName("mark_16_stealth_chestplate");
		}
	...
	public static class Leggings extends Mark16StealthItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(null));
			setRegistryName("mark_16_stealth_leggings");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/models/armor/empty_layer_2.png";
		}
	}

	public static class Boots extends Mark16StealthItem {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(null));
			setRegistryName("mark_16_stealth_boots");
		}
