...
public abstract class QuicksilverSuitItem extends ArmorItem {
	public QuicksilverSuitItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends QuicksilverSuitItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("quicksilver_suit_chestplate");
		}
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/quicksilver_layer_1.png";
		}
	}

	public static class Leggings extends QuicksilverSuitItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("quicksilver_suit_leggings");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/quicksilver_layer_2.png";
		}
	}

	public static class Boots extends QuicksilverSuitItem {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_COSTUMES));
			setRegistryName("quicksilver_suit_boots");
		}
