...
public abstract class IronManMark3Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark3Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark III - Open" : "Mark III"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark3_open.png" : "marvel:textures/mark3_helmet.png";
		}
	}
	...
	public static class Chestplate extends IronManMark3Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark III"));
		}
