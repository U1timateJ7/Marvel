...
public abstract class IronManMark33Item extends ArmorItem {
	public IronManMark33Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark33Item {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XXXIII - Open" : "Mark XXXIII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark33_open.png" : "marvel:textures/mark33_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark33Item {
		public Chestplate() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XXXIII"));
		}
	...
	public static class Leggings extends IronManMark33Item {
		public Leggings() {
	...
	public static class Boots extends IronManMark33Item {
		public Boots() {
