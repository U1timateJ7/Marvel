...
public abstract class IronManMark46Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark46Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XLVI - Open" : "Mark XLVI"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/models/armor/empty_layer_1.png" : "marvel:textures/mark46_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark46Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XLVI"));
		}
