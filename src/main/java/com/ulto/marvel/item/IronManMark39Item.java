...
public abstract class IronManMark39Item extends ArmorItem {
	public IronManMark39Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark39Item {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_39_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XXXIX - Open" : "Mark XXXIX"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark39_open.png" : "marvel:textures/mark39_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark39Item {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_39_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XXXIX"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/mark39_layer_1.png";
		}
	...
	public static class Leggings extends IronManMark39Item {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_39_leggings");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/mark39_layer_2.png";
		}
	}

	public static class Boots extends IronManMark39Item {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_39_boots");
		}
