...
public class WarMachineGunItem extends MarvelModElements.ModElement {
	@ObjectHolder("marvel:war_machine_gun")
	public static final Item block = null;
	@ObjectHolder("marvel:entitybulletwar_machine_gun")
	public static final EntityType arrow = null;
	public WarMachineGunItem(MarvelModElements instance) {
		super(instance, 211);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletwar_machine_gun").setRegistryName("entitybulletwar_machine_gun"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 2f, 0.5, 1);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("marvel:item.war_machine_gun.fire")),
