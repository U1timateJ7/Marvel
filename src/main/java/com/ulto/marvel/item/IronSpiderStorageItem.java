...
public abstract class IronSpiderStorageItem extends ArmorItem {
	public IronSpiderStorageItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends IronSpiderStorageItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_ITEMS));
			setRegistryName("iron_spider_storage_chestplate");
		}
