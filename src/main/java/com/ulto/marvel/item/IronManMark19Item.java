...
public abstract class IronManMark19Item extends ArmorItem {
	public IronManMark19Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark19Item {
		public Helmet() {
			super(EquipmentSlot.HEAD, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_19_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XIX - Open" : "Mark XIX"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark19_open.png" : "marvel:textures/mark19_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark19Item {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_19_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XIX"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/mark19_layer_1.png";
		}
	...
	public static class Leggings extends IronManMark19Item {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_19_leggings");
		}
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "marvel:textures/mark19_layer_2.png";
		}
	}

	public static class Boots extends IronManMark19Item {
		public Boots() {
			super(EquipmentSlot.FEET, new Item.Properties().tab(MarvelModTabs.TAB_IRON_MAN_ARMOR));
			setRegistryName("iron_man_mark_19_boots");
		}
