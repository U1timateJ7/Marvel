...
public abstract class IronManMark5Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark5Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark V - Open" : "Mark V"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark5_open.png" : "marvel:textures/mark5_helmet.png";
		}
	}
	...
	public static class Chestplate extends IronManMark5Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark V"));
		}
