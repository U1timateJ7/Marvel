...
public abstract class IronManMark25Item extends ArmorItem {
	public IronManMark25Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark25Item {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XXV - Open" : "Mark XXV"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark25_open.png" : "marvel:textures/mark25_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark25Item {
		public Chestplate() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XXV"));
		}
	...
	public static class Leggings extends IronManMark25Item {
		public Leggings() {
	...
	public static class Boots extends IronManMark25Item {
		public Boots() {
