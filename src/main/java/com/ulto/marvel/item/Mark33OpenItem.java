...
public abstract class Mark33OpenItem extends ArmorItem {
	public Mark33OpenItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends Mark33OpenItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("Mark XXXIII - Open"));
		}
