...
public abstract class IronManMark50Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark50Item {
		public Helmet() {
			...
			setRegistryName("iron_man_mark_50_helmet");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark L - Open" : "Mark L"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/models/armor/empty_layer_1.png" : "marvel:textures/mark50_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark50Item {
		public Chestplate() {
			...
			setRegistryName("iron_man_mark_50_chestplate");
		}
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark L"));
		}
	...
	public static class Leggings extends IronManMark50Item {
		public Leggings() {
			...
			setRegistryName("iron_man_mark_50_leggings");
		}
	...
	public static class Boots extends IronManMark50Item {
		public Boots() {
			...
			setRegistryName("iron_man_mark_50_boots");
		}
