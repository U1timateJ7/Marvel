...
public abstract class Mark50ArcReactorItem extends ArmorItem {
	public Mark50ArcReactorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Mark50ArcReactorItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(MarvelModTabs.TAB_MARVEL_ITEMS));
			setRegistryName("mark_50_arc_reactor_chestplate");
		}
