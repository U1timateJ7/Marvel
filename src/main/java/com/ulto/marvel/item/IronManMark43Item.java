...
public abstract class IronManMark43Item extends ArmorItem {
	...
	public static class Helmet extends IronManMark43Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XLIII - Open" : "Mark XLIII"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark43_open.png" : "marvel:textures/mark43_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark43Item {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XLIII"));
		}
