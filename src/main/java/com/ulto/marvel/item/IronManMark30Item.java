...
public abstract class IronManMark30Item extends ArmorItem {
	public IronManMark30Item(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends IronManMark30Item {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent(itemstack.getOrCreateTag().getBoolean("Open") ? "Mark XXX - Open" : "Mark XXX"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return stack.getOrCreateTag().getBoolean("Open") ? "marvel:textures/mark30_open.png" : "marvel:textures/mark30_helmet.png";
		}
	...
	public static class Chestplate extends IronManMark30Item {
		public Chestplate() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, world, list, flag);
			list.add(new TextComponent("Mark XXX"));
		}
	...
	public static class Leggings extends IronManMark30Item {
		public Leggings() {
	...
	public static class Boots extends IronManMark30Item {
		public Boots() {
