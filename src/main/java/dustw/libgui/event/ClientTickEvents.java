...
public class ClientTickEvents {
    ...
    public static void render(RenderGuiLayerEvent.Post event) {
        if (event.getName() == VanillaGuiLayers.CROSSHAIR) HudRenderCallback.EVENTS.forEach(e -> e.onHudRender(event.getGuiGraphics(), event.getPartialTick().getRealtimeDeltaTicks()));
    }
